...
const reportPath=path.join(root,'qa','runtime-structure-priority-probe-v1.5.25.json');
...
const out={baselineVersion:'1.5.19',targetVersion:'1.5.25',baselineImportant:666,removedCount:removed.length,remainingImportant:countImportant(),files:targetFiles,removed,skippedCount:skipped.length,unmappedSourceDeclarationCount:missing.length,unmappedSourceDeclarations:missing};
const output=path.join(root,'qa','runtime-structure-priority-v1.5.25.json');
let preserved=false;
