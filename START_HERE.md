...
```text
fix: repair API and engine connectivity
```
...
- 상단에 `BUILD v0.6.3`가 표시되는지 확인합니다.
- API quality에서 pytest 49개 이상이 통과하는지 확인합니다.
