...
현재 버전: `0.9.3-beta.3 · Verified Evidence & Long-form Export Soak + CI Hardening 3`
...
5. npm은 cache-only 후 registry 응답을 병렬 진단해 가용 endpoint부터 사용하고, preflight는 모든 실패를 보고서로 남깁니다.
