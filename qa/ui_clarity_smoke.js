...
ok(pkg.version === '1.5.24', 'UI clarity release version must be v1.5.24');
...
console.log('PASS v1.5.24 compact hero, clearer panel hierarchy, and header ownership cleanup');
