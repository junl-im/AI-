...
ok(pkg.version === '1.6.12', 'UI clarity release version must be v1.6.12');
...
console.log('PASS v1.6.12 compact hero, clearer panel hierarchy, and header ownership cleanup');
