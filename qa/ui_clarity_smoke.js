...
ok(/^1\.6\.\d+$/.test(pkg.version), 'UI clarity release version must be v1.6.25');
...
console.log('PASS v1.6.25 compact hero, clearer panel hierarchy, and header ownership cleanup');
