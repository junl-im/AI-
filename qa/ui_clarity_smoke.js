...
ok(pkg.version === '1.5.29', 'UI clarity release version must be v1.5.29');
...
console.log('PASS v1.5.29 compact hero, clearer panel hierarchy, and header ownership cleanup');
