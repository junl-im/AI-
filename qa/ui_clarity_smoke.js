...
ok(pkg.version === '1.5.7', 'UI clarity release version must be v1.5.7');
...
ok(css.includes('v1.5.7 hierarchy pass') && css.includes('.panel-head::before') && css.includes('.workspace-layout-button[aria-pressed="true"]'), 'panel and workspace hierarchy polish is present');
...
console.log('PASS v1.5.7 compact hero, clearer panel hierarchy, and header ownership cleanup');
