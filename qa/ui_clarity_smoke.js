...
ok(pkg.version === '1.6.4', 'UI clarity release version must be v1.6.4');
...
console.log('PASS v1.6.4 compact hero, clearer panel hierarchy, and header ownership cleanup');
