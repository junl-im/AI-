...
ok(pkg.version === '1.6.0', 'UI clarity release version must be v1.6.0');
...
console.log('PASS v1.6.0 compact hero, clearer panel hierarchy, and header ownership cleanup');
