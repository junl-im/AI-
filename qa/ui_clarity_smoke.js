...
ok(pkg.version === '1.6.15', 'UI clarity release version must be v1.6.15');
...
console.log('PASS v1.6.15 compact hero, clearer panel hierarchy, and header ownership cleanup');
