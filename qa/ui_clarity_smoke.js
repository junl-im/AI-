...
ok(pkg.version === '1.6.2', 'UI clarity release version must be v1.6.2');
...
console.log('PASS v1.6.2 compact hero, clearer panel hierarchy, and header ownership cleanup');
