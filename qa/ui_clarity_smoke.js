...
ok(pkg.version === '1.5.16', 'UI clarity release version must be v1.5.16');
...
console.log('PASS v1.5.16 compact hero, clearer panel hierarchy, and header ownership cleanup');
