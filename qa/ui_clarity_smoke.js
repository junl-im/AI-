...
ok(pkg.version === '1.6.3', 'UI clarity release version must be v1.6.3');
...
console.log('PASS v1.6.3 compact hero, clearer panel hierarchy, and header ownership cleanup');
