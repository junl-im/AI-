...
ok(pkg.version === '1.5.17', 'UI clarity release version must be v1.5.17');
...
console.log('PASS v1.5.17 compact hero, clearer panel hierarchy, and header ownership cleanup');
