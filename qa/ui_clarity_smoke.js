...
ok(pkg.version === '1.6.9', 'UI clarity release version must be v1.6.9');
...
console.log('PASS v1.6.9 compact hero, clearer panel hierarchy, and header ownership cleanup');
