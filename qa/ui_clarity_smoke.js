...
ok(pkg.version === '1.6.5', 'UI clarity release version must be v1.6.5');
...
console.log('PASS v1.6.5 compact hero, clearer panel hierarchy, and header ownership cleanup');
