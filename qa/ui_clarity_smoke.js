...
ok(pkg.version === '1.5.27', 'UI clarity release version must be v1.5.27');
...
console.log('PASS v1.5.27 compact hero, clearer panel hierarchy, and header ownership cleanup');
