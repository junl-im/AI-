...
ok(pkg.version === '1.5.28', 'UI clarity release version must be v1.5.28');
...
console.log('PASS v1.5.28 compact hero, clearer panel hierarchy, and header ownership cleanup');
