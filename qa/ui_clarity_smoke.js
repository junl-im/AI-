...
ok(pkg.version === '1.5.25', 'UI clarity release version must be v1.5.25');
...
console.log('PASS v1.5.25 compact hero, clearer panel hierarchy, and header ownership cleanup');
