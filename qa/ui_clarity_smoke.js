...
ok(pkg.version === '1.6.13', 'UI clarity release version must be v1.6.13');
...
console.log('PASS v1.6.13 compact hero, clearer panel hierarchy, and header ownership cleanup');
