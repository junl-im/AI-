...
ok(pkg.version === '1.6.1', 'UI clarity release version must be v1.6.1');
...
console.log('PASS v1.6.1 compact hero, clearer panel hierarchy, and header ownership cleanup');
