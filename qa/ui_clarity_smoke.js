...
ok(pkg.version === '1.5.14', 'UI clarity release version must be v1.5.14');
...
ok(css.includes('v1.5.14 hierarchy pass') && css.includes('.panel-head::before') && css.includes('.workspace-layout-button[aria-pressed="true"]'), 'panel and workspace hierarchy polish is present');
...
console.log('PASS v1.5.14 compact hero, clearer panel hierarchy, and header ownership cleanup');
