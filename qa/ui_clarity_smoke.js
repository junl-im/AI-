...
ok(pkg.version === '1.6.24', 'UI clarity release version must be v1.6.24');
...
console.log('PASS v1.6.24 compact hero, clearer panel hierarchy, and header ownership cleanup');
