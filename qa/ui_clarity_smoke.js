...
ok(pkg.version === '1.5.26', 'UI clarity release version must be v1.5.26');
...
console.log('PASS v1.5.26 compact hero, clearer panel hierarchy, and header ownership cleanup');
