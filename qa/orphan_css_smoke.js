...
assert(pkg.version === '1.5.25', 'orphan CSS cleanup release version is v1.5.25');
...
console.log('PASS v1.5.25 unified-import CSS pruning and source-reachable guardrails');
