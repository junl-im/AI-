...
assert(pkg.version === '1.6.24', 'orphan CSS cleanup release version matches package version');
...
console.log('PASS v1.6.24 unified-import CSS pruning and source-reachable guardrails');
