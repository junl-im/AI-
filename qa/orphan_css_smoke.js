...
assert(pkg.version === '1.5.26', 'orphan CSS cleanup release version is v1.5.26');
...
console.log('PASS v1.5.26 unified-import CSS pruning and source-reachable guardrails');
