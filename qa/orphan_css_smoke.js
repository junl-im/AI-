...
assert(pkg.version === '1.5.27', 'orphan CSS cleanup release version is v1.5.27');
...
console.log('PASS v1.5.27 unified-import CSS pruning and source-reachable guardrails');
