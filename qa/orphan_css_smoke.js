...
assert(pkg.version === '1.6.2', 'orphan CSS cleanup release version is v1.6.2');
...
console.log('PASS v1.6.2 unified-import CSS pruning and source-reachable guardrails');
