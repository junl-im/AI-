...
assert(pkg.version === '1.6.12', 'orphan CSS cleanup release version is v1.6.12');
...
console.log('PASS v1.6.12 unified-import CSS pruning and source-reachable guardrails');
