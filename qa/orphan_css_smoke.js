...
assert(pkg.version === '1.6.0', 'orphan CSS cleanup release version is v1.6.0');
...
console.log('PASS v1.6.0 unified-import CSS pruning and source-reachable guardrails');
