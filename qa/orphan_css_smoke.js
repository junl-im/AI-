...
assert(pkg.version === '1.6.3', 'orphan CSS cleanup release version is v1.6.3');
...
console.log('PASS v1.6.3 unified-import CSS pruning and source-reachable guardrails');
