...
assert(pkg.version === '1.5.20', 'orphan CSS cleanup release version is v1.5.20');
...
console.log('PASS v1.5.20 unified-import CSS pruning and source-reachable guardrails');
