...
assert(pkg.version === '1.6.1', 'orphan CSS cleanup release version is v1.6.1');
...
console.log('PASS v1.6.1 unified-import CSS pruning and source-reachable guardrails');
