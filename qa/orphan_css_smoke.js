...
assert(pkg.version === '1.6.5', 'orphan CSS cleanup release version is v1.6.5');
...
console.log('PASS v1.6.5 unified-import CSS pruning and source-reachable guardrails');
