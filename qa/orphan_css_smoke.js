...
assert(pkg.version === '1.6.4', 'orphan CSS cleanup release version is v1.6.4');
...
console.log('PASS v1.6.4 unified-import CSS pruning and source-reachable guardrails');
