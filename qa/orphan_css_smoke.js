...
assert(/^1\.6\.\d+$/.test(pkg.version), 'orphan CSS cleanup release version matches package version');
...
console.log('PASS v1.6.25 unified-import CSS pruning and source-reachable guardrails');
