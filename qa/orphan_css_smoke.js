...
assert(pkg.version === '1.5.28', 'orphan CSS cleanup release version is v1.5.28');
...
console.log('PASS v1.5.28 unified-import CSS pruning and source-reachable guardrails');
