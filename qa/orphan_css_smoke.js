...
assert(pkg.version === '1.5.24', 'orphan CSS cleanup release version is v1.5.24');
...
console.log('PASS v1.5.24 unified-import CSS pruning and source-reachable guardrails');
