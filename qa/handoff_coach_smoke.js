...
ok(html.includes('assets/css/handoff-coach.css?v=1.1.7-handoff-coach'), 'handoff coach stylesheet is linked');
ok(html.includes('src/ui/handoff-coach.js?v=1.1.7-handoff-coach'), 'handoff coach script is linked');
ok(sw.includes('./assets/css/handoff-coach.css?v=1.1.7-handoff-coach'), 'handoff coach stylesheet is cached');
ok(sw.includes('./src/ui/handoff-coach.js?v=1.1.7-handoff-coach'), 'handoff coach script is cached');
