...
ok(html.includes('assets/css/handoff-coach.css?v=1.3.6-adaptive-mobile'), 'handoff coach stylesheet is linked');
ok(loader.includes("versioned('src/ui/handoff-coach.js', 'editing')"), 'handoff coach script is staged');
ok(sw.includes('./assets/css/handoff-coach.css?v=1.3.6-adaptive-mobile'), 'handoff coach stylesheet is cached');
