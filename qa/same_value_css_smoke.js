...
assert(pkg.version === '1.5.20', 'same-value CSS cleanup release version is v1.5.20');
...
console.log('PASS v1.5.20 duplicate-free CSS declaration ownership guardrails');
