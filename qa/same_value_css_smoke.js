...
assert(pkg.version === '1.5.25', 'same-value CSS cleanup release version is v1.5.25');
...
console.log('PASS v1.5.25 duplicate-free CSS declaration ownership guardrails');
