...
assert(pkg.version === '1.5.26', 'same-value CSS cleanup release version is v1.5.26');
...
console.log('PASS v1.5.26 duplicate-free CSS declaration ownership guardrails');
