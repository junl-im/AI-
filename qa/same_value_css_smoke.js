...
assert(pkg.version === '1.5.17', 'same-value CSS cleanup release version is v1.5.17');
...
console.log('PASS v1.5.17 duplicate-free CSS declaration ownership guardrails');
