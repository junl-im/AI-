...
assert(pkg.version === '1.5.29', 'same-value CSS cleanup release version is v1.5.29');
...
console.log('PASS v1.5.29 duplicate-free CSS declaration ownership guardrails');
