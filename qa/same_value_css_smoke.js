...
assert(pkg.version === '1.5.28', 'same-value CSS cleanup release version is v1.5.28');
...
console.log('PASS v1.5.28 duplicate-free CSS declaration ownership guardrails');
