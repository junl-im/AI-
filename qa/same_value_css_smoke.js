...
assert(/^1\.6\.\d+$/.test(pkg.version), 'same-value CSS cleanup release version is v1.6.25');
...
console.log('PASS v1.6.25 duplicate-free CSS declaration ownership guardrails');
