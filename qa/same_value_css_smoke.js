...
assert(pkg.version === '1.5.27', 'same-value CSS cleanup release version is v1.5.27');
...
console.log('PASS v1.5.27 duplicate-free CSS declaration ownership guardrails');
