...
assert(pkg.version === '1.6.12', 'same-value CSS cleanup release version is v1.6.12');
...
console.log('PASS v1.6.12 duplicate-free CSS declaration ownership guardrails');
