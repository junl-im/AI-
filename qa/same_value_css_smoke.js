...
assert(pkg.version === '1.6.15', 'same-value CSS cleanup release version is v1.6.15');
...
console.log('PASS v1.6.15 duplicate-free CSS declaration ownership guardrails');
