...
assert(pkg.version === '1.6.13', 'same-value CSS cleanup release version is v1.6.13');
...
console.log('PASS v1.6.13 duplicate-free CSS declaration ownership guardrails');
