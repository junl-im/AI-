...
assert(pkg.version === '1.6.24', 'same-value CSS cleanup release version is v1.6.24');
...
console.log('PASS v1.6.24 duplicate-free CSS declaration ownership guardrails');
