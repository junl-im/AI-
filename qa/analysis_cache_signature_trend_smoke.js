...
(async () => {
    ...
    const window = {
        ...
        AIShortsRuntimeConfig: { APP_VERSION: 'v1.6.2', ANALYSIS_CACHE_STORAGE_TREND_LIMIT: 12 },
    ...
    const cache = api.createPersistentAnalysisCache({ databaseName: 'signature-trend-test', namespace: 'analysis-contract-v3', contractVersion: '3', appVersion: '1.6.2', maxItems: 8, maxBytes: 8 * 1024 * 1024, storageTrendLimit: 12 });
