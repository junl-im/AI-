...
(async () => {
    ...
    const window = { indexedDB, navigator: { storage: { async estimate() { return { usage: 100, quota: 1000 }; } } }, AIShortsRuntimeConfig: { APP_VERSION: 'v1.6.5' }, structuredClone: global.structuredClone };
    ...
    const cache = window.AIShortsAnalysisCache.createPersistentAnalysisCache({ namespace: 'analysis-contract-v2', contractVersion: '2', appVersion: '1.6.5', maxItems: 8, maxBytes: 8 * 1024 * 1024 });
    await cache.set('a::video/mp4::::100::1::10::fp-a::balanced::16000::40::analysis-contract-v2', { score: 1 }, { tier: 'balanced', contractVersion: '2', appVersion: '1.6.5' });
    await cache.set('b::video/mp4::::100::1::10::fp-b::quality::48000::80::analysis-contract-v2', { score: 2 }, { tier: 'quality', contractVersion: '2', appVersion: '1.6.5' });
    await cache.set('c::video/mp4::::100::1::10::fp-c::balanced::16000::40::analysis-contract-v2', { score: 3 }, { tier: 'balanced', contractVersion: '1', appVersion: '1.6.5' });
