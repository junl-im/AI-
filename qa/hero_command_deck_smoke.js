...
assert(pkg.version === '1.5.20', 'shorts pulse hero release version is v1.5.20');
assert(html.includes('assets/css/hero-command-deck.css?v=1.5.20-structure-responsive-priority'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.5.20-structure-responsive-priority'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.5.20-structure-responsive-priority') && sw.includes('./assets/css/header-meta-rail.css?v=1.5.20-structure-responsive-priority'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.5.20 shorts pulse hero guardrails present');
