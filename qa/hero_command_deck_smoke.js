...
assert(pkg.version === '1.5.28', 'shorts pulse hero release version is v1.5.28');
assert(html.includes('assets/css/hero-command-deck.css?v=1.5.28-analysis-namespace-maintenance-history'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.5.28-analysis-namespace-maintenance-history'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.5.28-analysis-namespace-maintenance-history') && sw.includes('./assets/css/header-meta-rail.css?v=1.5.28-analysis-namespace-maintenance-history'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.5.28 shorts pulse hero guardrails present');
