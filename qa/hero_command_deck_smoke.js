...
assert(pkg.version === '1.3.4', 'shorts pulse hero release version is v1.3.4');
assert(html.includes('assets/css/hero-command-deck.css?v=1.3.4-adaptive-mobile'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.3.4-adaptive-mobile'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.3.4-adaptive-mobile') && sw.includes('./assets/css/header-meta-rail.css?v=1.3.4-adaptive-mobile'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.3.4 shorts pulse hero guardrails present');
