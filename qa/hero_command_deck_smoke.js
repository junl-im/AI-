...
assert(pkg.version === '1.5.14', 'shorts pulse hero release version is v1.5.14');
assert(html.includes('assets/css/hero-command-deck.css?v=1.5.14-cascade-dedup'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.5.14-cascade-dedup'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.5.14-cascade-dedup') && sw.includes('./assets/css/header-meta-rail.css?v=1.5.14-cascade-dedup'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.5.14 shorts pulse hero guardrails present');
