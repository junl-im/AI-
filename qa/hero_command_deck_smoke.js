...
assert(pkg.version === '1.3.0', 'shorts pulse hero release version is v1.3.0');
assert(html.includes('assets/css/hero-command-deck.css?v=1.3.0-stage-beacon'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.3.0-stage-beacon'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.3.0-stage-beacon') && sw.includes('./assets/css/header-meta-rail.css?v=1.3.0-stage-beacon'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.3.0 shorts pulse hero guardrails present');
