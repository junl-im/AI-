...
assert(pkg.version === '1.5.16', 'shorts pulse hero release version is v1.5.16');
assert(html.includes('assets/css/hero-command-deck.css?v=1.5.16-unified-import-ui'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.5.16-unified-import-ui'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.5.16-unified-import-ui') && sw.includes('./assets/css/header-meta-rail.css?v=1.5.16-unified-import-ui'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.5.16 shorts pulse hero guardrails present');
