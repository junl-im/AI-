...
assert(pkg.version === '1.2.8', 'shorts pulse hero release version is v1.2.8');
assert(html.includes('assets/css/hero-command-deck.css?v=1.2.8-header-meta'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.2.8-header-meta'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.2.8-header-meta') && sw.includes('./assets/css/header-meta-rail.css?v=1.2.8-header-meta'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.2.8 shorts pulse hero guardrails present');
