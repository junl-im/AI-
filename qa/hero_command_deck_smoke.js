...
assert(pkg.version === '1.6.9', 'shorts pulse hero release version is v1.6.9');
assert(html.includes('assets/css/hero-command-deck.css?v=1.6.9-direct-crop-editor'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.6.9-direct-crop-editor'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.6.9-direct-crop-editor') && sw.includes('./assets/css/header-meta-rail.css?v=1.6.9-direct-crop-editor'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.6.9 shorts pulse hero guardrails present');
