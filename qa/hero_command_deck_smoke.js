...
assert(html.includes(`assets/css/header-meta-rail.css?v=${buildKey}`) && sw.includes(`./assets/css/header-meta-rail.css?v=${buildKey}`), 'two-sided metadata rail override is linked and cached');
