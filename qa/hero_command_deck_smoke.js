...
assert(pkg.version === '1.6.5', 'shorts pulse hero release version is v1.6.5');
assert(html.includes('assets/css/hero-command-deck.css?v=1.6.5-smart-reframe-caption-safe'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.6.5-smart-reframe-caption-safe'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('assets/css/header-meta-rail.css?v=1.6.5-smart-reframe-caption-safe') && sw.includes('./assets/css/header-meta-rail.css?v=1.6.5-smart-reframe-caption-safe'), 'two-sided metadata rail override is linked and cached');
...
console.log('PASS v1.6.5 shorts pulse hero guardrails present');
