...
assert(pkg.version === '1.2.3', 'shorts pulse hero release version is v1.2.3');
assert(html.includes('assets/css/hero-command-deck.css?v=1.2.3-shorts-pulse-hero'), 'shorts pulse hero stylesheet is linked');
...
assert(sw.includes('./assets/css/hero-command-deck.css?v=1.2.3-shorts-pulse-hero'), 'shorts pulse hero stylesheet is cached');
...
assert(html.includes('LOCAL RENDER · 9:16 READY'), 'local vertical rendering state is clear');
...
console.log('PASS v1.2.3 shorts pulse hero guardrails present');
