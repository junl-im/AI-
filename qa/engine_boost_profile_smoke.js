...
ok(html.includes(`src/engine/engine-boost-profile.js?v=${version}-css-ownership`), 'engine boost profile script linked');
ok(sw.includes(`./src/engine/engine-boost-profile.js?v=${version}-css-ownership`), 'engine boost profile script cached');
