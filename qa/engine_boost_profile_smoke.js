...
ok(html.includes(`src/engine/engine-boost-profile.js?v=${version}-mobile-control-ownership`), 'engine boost profile script linked');
ok(sw.includes(`./src/engine/engine-boost-profile.js?v=${version}-mobile-control-ownership`), 'engine boost profile script cached');
