...
ok(html.includes(`src/engine/engine-boost-profile.js?v=${version}-stage-beacon`), 'engine boost profile script linked');
ok(sw.includes(`./src/engine/engine-boost-profile.js?v=${version}-stage-beacon`), 'engine boost profile script cached');
