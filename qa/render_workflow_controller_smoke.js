...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.3-stage-focus-progressive-disclosure'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.3 modular render workflow guardrails');
})().catch(error => {
