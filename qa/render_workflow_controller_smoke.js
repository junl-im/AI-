...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.25 modular render workflow guardrails');
})().catch(error => {
