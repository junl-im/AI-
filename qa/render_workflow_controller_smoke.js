...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.27 modular render workflow guardrails');
})().catch(error => {
