...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.5-smart-reframe-caption-safe'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.5 modular render workflow guardrails');
})().catch(error => {
