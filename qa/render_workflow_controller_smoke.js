...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.4-recovery-loop-impact-preview'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.4 modular render workflow guardrails');
})().catch(error => {
