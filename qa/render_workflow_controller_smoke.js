...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.29-analysis-signature-storage-trend'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.29 modular render workflow guardrails');
})().catch(error => {
