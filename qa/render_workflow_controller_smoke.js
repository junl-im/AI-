...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.6-ui-clarity'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.6 modular render workflow guardrails');
})().catch(error => {
