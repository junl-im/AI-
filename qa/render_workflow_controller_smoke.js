...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.4.1-adaptive-mobile'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.4.1 modular render workflow guardrails');
})().catch(error => {
