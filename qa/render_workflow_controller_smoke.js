...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.0-local-ai-provider-foundation'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.0 modular render workflow guardrails');
})().catch(error => {
