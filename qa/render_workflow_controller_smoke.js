...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.7-responsive-density'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.7 modular render workflow guardrails');
})().catch(error => {
