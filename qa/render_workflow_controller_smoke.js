...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.12-model-pack-benchmark-rollback'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.12 modular render workflow guardrails');
})().catch(error => {
