...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.2-layout-harmony-footer-health'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.2 modular render workflow guardrails');
})().catch(error => {
