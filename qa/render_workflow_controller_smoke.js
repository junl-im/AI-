...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.5-mobile-control-ownership'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.5 modular render workflow guardrails');
})().catch(error => {
