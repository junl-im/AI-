...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.16-unified-import-ui'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.16 modular render workflow guardrails');
})().catch(error => {
