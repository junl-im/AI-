...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.13-transactional-model-pack-qa-controls'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.13 modular render workflow guardrails');
})().catch(error => {
