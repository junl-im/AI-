...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.6.9-direct-crop-editor'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.6.9 modular render workflow guardrails');
})().catch(error => {
