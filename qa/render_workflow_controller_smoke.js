...
assert(sw.includes('./src/app/render-workflow-controller.js?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'render workflow controller is available offline');
...
(async () => {
    ...
    console.log('PASS v1.5.26 modular render workflow guardrails');
})().catch(error => {
