...
if (!html.includes('assets/css/cinematic-hero.css?v=1.0.1-responsive-layout')) fail('cinematic hero stylesheet link missing');
...
if (!sw.includes('./assets/css/cinematic-hero.css?v=1.0.1-responsive-layout')) fail('service worker should cache cinematic hero css');
