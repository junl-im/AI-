...
if (!html.includes('assets/css/cinematic-hero.css?v=1.1.0-flow-audit')) fail('cinematic hero stylesheet link missing');
...
if (!sw.includes('./assets/css/cinematic-hero.css?v=1.1.0-flow-audit')) fail('service worker should cache cinematic hero css');
