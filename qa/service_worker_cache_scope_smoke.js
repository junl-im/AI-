...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.20-structure-responsive-priority',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.20-structure-responsive-priority'), 'current AI Shorts shell cache is preserved');
