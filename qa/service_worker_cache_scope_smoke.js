...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.5-mobile-control-ownership',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.5-mobile-control-ownership'), 'current AI Shorts shell cache is preserved');
