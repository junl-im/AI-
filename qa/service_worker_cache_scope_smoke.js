...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.6.0-local-ai-provider-foundation',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.6.0-local-ai-provider-foundation'), 'current AI Shorts shell cache is preserved');
