...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.6.1-advanced-diagnostics-gate',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.6.1-advanced-diagnostics-gate'), 'current AI Shorts shell cache is preserved');
