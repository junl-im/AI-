...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.24-compressed-session-integrity-rollback',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.24-compressed-session-integrity-rollback'), 'current AI Shorts shell cache is preserved');
