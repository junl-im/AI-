...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.6.5-smart-reframe-caption-safe',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.6.5-smart-reframe-caption-safe'), 'current AI Shorts shell cache is preserved');
