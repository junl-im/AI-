...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.14-cascade-dedup',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.14-cascade-dedup'), 'current AI Shorts shell cache is preserved');
