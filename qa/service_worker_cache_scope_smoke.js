...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.7-responsive-density',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.7-responsive-density'), 'current AI Shorts shell cache is preserved');
