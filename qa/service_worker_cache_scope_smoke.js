...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.2-experience-engine',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.2-experience-engine'), 'current AI Shorts shell cache is preserved');
