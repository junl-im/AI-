...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.26-adaptive-cache-audit-protected-recovery',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.26-adaptive-cache-audit-protected-recovery'), 'current AI Shorts shell cache is preserved');
