...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.6.9-direct-crop-editor',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.6.9-direct-crop-editor'), 'current AI Shorts shell cache is preserved');
