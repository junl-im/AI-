...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.17-important-cascade-reduction',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.17-important-cascade-reduction'), 'current AI Shorts shell cache is preserved');
