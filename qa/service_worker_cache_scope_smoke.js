...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.25-persistent-analysis-selective-recovery-integrity-audit',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'current AI Shorts shell cache is preserved');
