...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.16-unified-import-ui',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.16-unified-import-ui'), 'current AI Shorts shell cache is preserved');
