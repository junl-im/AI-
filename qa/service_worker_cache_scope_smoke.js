...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.6.4-recovery-loop-impact-preview',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.6.4-recovery-loop-impact-preview'), 'current AI Shorts shell cache is preserved');
