...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.6.12-model-pack-benchmark-rollback',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.6.12-model-pack-benchmark-rollback'), 'current AI Shorts shell cache is preserved');
