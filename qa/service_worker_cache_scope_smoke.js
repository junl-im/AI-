...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.6.3-stage-focus-progressive-disclosure',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.6.3-stage-focus-progressive-disclosure'), 'current AI Shorts shell cache is preserved');
