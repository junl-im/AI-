...
(async () => {
    ...
    const caches = {
        keys: async () => [
            ...
            'ai-shorts-studio-shell-v1.5.29-analysis-signature-storage-trend',
    ...
    ok(!deleted.includes('ai-shorts-studio-shell-v1.5.29-analysis-signature-storage-trend'), 'current AI Shorts shell cache is preserved');
