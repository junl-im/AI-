...
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.6.0-local-ai-provider-foundation');
if (!loader.includes("versioned('src/ui/workspace-comfort.js', 'shell')")) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.6.0-local-ai-provider-foundation');
...
if (!html.includes('>v1.6.0</button>')) fail('header version badge must be v1.6.0');
