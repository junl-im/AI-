...
if (pkg.version !== '1.2.6') fail('package version must be 1.2.6');
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.2.6-workspace-comfort');
if (!loader.includes('src/ui/workspace-comfort.js?v=${VERSION}-workspace-comfort')) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.2.6-workspace-comfort');
...
if (!html.includes('>v1.2.6</button>')) fail('header version badge must be v1.2.6');
