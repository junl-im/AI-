...
if (pkg.version !== '1.1.3') fail('package version must be 1.1.3');
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.1.3-workspace-comfort');
assertIncludes('index.html', 'src/ui/workspace-comfort.js?v=1.1.3-workspace-comfort');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.1.3-workspace-comfort');
assertIncludes('sw.js', 'workspace-comfort.js?v=1.1.3-workspace-comfort');
...
if (!html.includes('>v1.1.3</button>')) fail('header version badge must be v1.1.3');
