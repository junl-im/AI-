...
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.3.8-adaptive-mobile');
if (!loader.includes("versioned('src/ui/workspace-comfort.js', 'shell')")) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.3.8-adaptive-mobile');
...
if (!html.includes('>v1.3.8</button>')) fail('header version badge must be v1.3.8');
