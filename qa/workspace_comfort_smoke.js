...
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.0.5-workspace-comfort');
assertIncludes('index.html', 'src/ui/workspace-comfort.js?v=1.0.5-workspace-comfort');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.0.5-workspace-comfort');
assertIncludes('sw.js', 'workspace-comfort.js?v=1.0.5-workspace-comfort');
...
if (!html.includes('>v1.0.5</button>')) fail('header version badge must be v1.0.5');
