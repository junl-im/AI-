...
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.5.27-selective-cache-integrity-retry-portable-backup');
if (!loader.includes("versioned('src/ui/workspace-comfort.js', 'shell')")) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.5.27-selective-cache-integrity-retry-portable-backup');
...
if (!html.includes('>v1.5.27</button>')) fail('header version badge must be v1.5.27');
