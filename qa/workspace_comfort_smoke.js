...
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.6.13-transactional-model-pack-qa-controls');
if (!loader.includes("versioned('src/ui/workspace-comfort.js', 'shell')")) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.6.13-transactional-model-pack-qa-controls');
...
if (!html.includes('>v1.6.13</button>')) fail('header version badge must be v1.6.13');
