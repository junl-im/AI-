...
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.2.9-stability-audit');
if (!loader.includes("versioned('src/ui/workspace-comfort.js', 'shell')")) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.2.9-stability-audit');
...
if (!html.includes('>v1.2.9</button>')) fail('header version badge must be v1.2.9');
