...
if (pkg.version !== '1.2.8') fail('package version must be 1.2.8');
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.2.8-header-meta');
if (!loader.includes('src/ui/workspace-comfort.js?v=${VERSION}-workspace-comfort')) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.2.8-header-meta');
...
if (!html.includes('>v1.2.8</button>')) fail('header version badge must be v1.2.8');
