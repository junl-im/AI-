...
if (pkg.version !== '1.2.3') fail('package version must be 1.2.3');
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.2.3-workspace-comfort');
assertIncludes('index.html', 'src/ui/workspace-comfort.js?v=1.2.3-workspace-comfort');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.2.3-workspace-comfort');
assertIncludes('sw.js', 'workspace-comfort.js?v=1.2.3-workspace-comfort');
...
if (!html.includes('>v1.2.3</button>')) fail('header version badge must be v1.2.3');
