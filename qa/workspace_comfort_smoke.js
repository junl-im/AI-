...
assertIncludes('index.html', 'assets/css/workspace-comfort.css?v=1.5.4-css-ownership');
if (!loader.includes("versioned('src/ui/workspace-comfort.js', 'shell')")) fail('workspace comfort script must be staged');
assertIncludes('sw.js', 'workspace-comfort.css?v=1.5.4-css-ownership');
...
if (!html.includes('>v1.5.4</button>')) fail('header version badge must be v1.5.4');
