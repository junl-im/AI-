...
has('index.html', 'assets/css/motion-stability.css?v=1.6.15-preview-cache-diagnostics');
has('index.html', 'src/ui/motion-stability.js?v=1.6.15-preview-cache-diagnostics');
...
has('sw.js', 'motion-stability.css?v=1.6.15-preview-cache-diagnostics');
has('sw.js', 'motion-stability.js?v=1.6.15-preview-cache-diagnostics');
