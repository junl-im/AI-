...
if (pkg.version !== '1.5.0') fail('package version must be 1.2.9');
has('index.html', 'assets/css/motion-stability.css?v=1.5.0-experience-engine');
has('index.html', 'src/ui/motion-stability.js?v=1.5.0-experience-engine');
...
has('sw.js', 'motion-stability.css?v=1.5.0-experience-engine');
has('sw.js', 'motion-stability.js?v=1.5.0-experience-engine');
