...
if (pkg.version !== '1.5.29') fail('package version must be 1.2.9');
has('index.html', 'assets/css/motion-stability.css?v=1.5.29-analysis-signature-storage-trend');
has('index.html', 'src/ui/motion-stability.js?v=1.5.29-analysis-signature-storage-trend');
...
has('sw.js', 'motion-stability.css?v=1.5.29-analysis-signature-storage-trend');
has('sw.js', 'motion-stability.js?v=1.5.29-analysis-signature-storage-trend');
