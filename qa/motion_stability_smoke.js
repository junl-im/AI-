...
has('index.html', 'assets/css/motion-stability.css?v=1.2.1-motion-stability');
has('index.html', 'src/ui/motion-stability.js?v=1.2.1-motion-stability');
...
has('sw.js', 'motion-stability.css?v=1.2.1-motion-stability');
has('sw.js', 'motion-stability.js?v=1.2.1-motion-stability');
