...
if (pkg.version !== '1.5.24') fail('package version must be 1.2.9');
has('index.html', 'assets/css/motion-stability.css?v=1.5.24-compressed-session-integrity-rollback');
has('index.html', 'src/ui/motion-stability.js?v=1.5.24-compressed-session-integrity-rollback');
...
has('sw.js', 'motion-stability.css?v=1.5.24-compressed-session-integrity-rollback');
has('sw.js', 'motion-stability.js?v=1.5.24-compressed-session-integrity-rollback');
