...
has('index.html', 'assets/css/motion-stability.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
has('index.html', 'src/ui/motion-stability.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
...
has('sw.js', 'motion-stability.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
has('sw.js', 'motion-stability.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
