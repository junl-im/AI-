...
if (pkg.version !== '1.6.2') fail('package version must be 1.2.9');
has('index.html', 'assets/css/motion-stability.css?v=1.6.2-layout-harmony-footer-health');
has('index.html', 'src/ui/motion-stability.js?v=1.6.2-layout-harmony-footer-health');
...
has('sw.js', 'motion-stability.css?v=1.6.2-layout-harmony-footer-health');
has('sw.js', 'motion-stability.js?v=1.6.2-layout-harmony-footer-health');
