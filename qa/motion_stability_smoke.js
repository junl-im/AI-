...
if (pkg.version !== '1.2.9') fail('package version must be 1.2.9');
has('index.html', 'assets/css/motion-stability.css?v=1.2.9-stability-audit');
has('index.html', 'src/ui/motion-stability.js?v=1.2.9-stability-audit');
...
has('sw.js', 'motion-stability.css?v=1.2.9-stability-audit');
has('sw.js', 'motion-stability.js?v=1.2.9-stability-audit');
