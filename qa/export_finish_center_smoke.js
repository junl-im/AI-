...
assert(pkg.version === '1.1.4', 'package version must be 1.1.4');
includes('index.html', 'assets/css/export-finish-center.css?v=1.1.4-export-finish');
includes('index.html', 'src/ui/export-finish-center.js?v=1.1.4-export-finish');
includes('sw.js', './assets/css/export-finish-center.css?v=1.1.4-export-finish');
includes('sw.js', './src/ui/export-finish-center.js?v=1.1.4-export-finish');
