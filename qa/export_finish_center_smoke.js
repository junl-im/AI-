...
assert(pkg.version === '1.3.7', 'package version must be 1.2.9');
includes('index.html', 'assets/css/export-finish-center.css?v=1.3.7-adaptive-mobile');
assert(loader.includes("versioned('src/ui/export-finish-center.js', 'export')"), 'export finish center script must be staged');
includes('sw.js', './assets/css/export-finish-center.css?v=1.3.7-adaptive-mobile');
