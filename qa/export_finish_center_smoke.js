...
includes('index.html', 'assets/css/export-finish-center.css?v=1.2.9-stability-audit');
assert(loader.includes("versioned('src/ui/export-finish-center.js', 'export')"), 'export finish center script must be staged');
includes('sw.js', './assets/css/export-finish-center.css?v=1.2.9-stability-audit');
