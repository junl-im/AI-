...
assert(pkg.version === '1.1.9', 'package version must be 1.1.9');
includes('index.html', 'assets/css/export-finish-center.css?v=1.1.9-export-finish');
includes('index.html', 'src/ui/export-finish-center.js?v=1.1.9-export-finish');
includes('sw.js', './assets/css/export-finish-center.css?v=1.1.9-export-finish');
includes('sw.js', './src/ui/export-finish-center.js?v=1.1.9-export-finish');
