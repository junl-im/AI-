...
(async () => {
    ...
    const window = {
        ...
        AIShortsRuntimeConfig: { APP_VERSION: 'v1.6.2', ANALYSIS_CACHE_MAINTENANCE_HISTORY_LIMIT: 20 },
    ...
    await legacy.set('legacy-private-name.mp4::video/mp4::::100::1::10::legacy-fingerprint::balanced::16000::40::analysis-contract-v1', { score: 1 }, { tier: 'balanced', contractVersion: '1', appVersion: '1.6.2' });
    ...
    await current.set('current-private-name.mp4::video/mp4::::100::1::10::current-fingerprint::quality::48000::80::analysis-contract-v2', { score: 2 }, { tier: 'quality', contractVersion: '2', appVersion: '1.6.2' });
