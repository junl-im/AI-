...
const probe = readJson('qa/runtime-structure-priority-probe-v1.6.15.json');
...
ok(pkg.version === '1.6.15', 'structure and responsive priority release version is v1.6.15');
ok(reduction.baselineVersion === '1.5.19' && reduction.targetVersion === '1.6.13', 'v1.6.15 inherits the verified v1.5.19 to v1.6.13 priority reduction contract');
...
console.log('PASS v1.6.15 structural and responsive priority reduction with unchanged layout metrics');
