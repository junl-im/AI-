...
const reduction = readJson('qa/runtime-structure-priority-v1.6.2.json');
const probe = readJson('qa/runtime-structure-priority-probe-v1.6.2.json');
...
ok(pkg.version === '1.6.2', 'structure and responsive priority release version is v1.6.2');
ok(reduction.baselineVersion === '1.5.19' && reduction.targetVersion === '1.6.2', 'reduction is anchored to the v1.5.19 baseline');
...
console.log('PASS v1.6.2 structural and responsive priority reduction with unchanged layout metrics');
