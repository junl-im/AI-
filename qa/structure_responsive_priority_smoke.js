...
const reduction = readJson('qa/runtime-structure-priority-v1.5.29.json');
const probe = readJson('qa/runtime-structure-priority-probe-v1.5.29.json');
...
ok(pkg.version === '1.5.29', 'structure and responsive priority release version is v1.5.29');
ok(reduction.baselineVersion === '1.5.19' && reduction.targetVersion === '1.5.29', 'reduction is anchored to the v1.5.19 baseline');
...
console.log('PASS v1.5.29 structural and responsive priority reduction with unchanged layout metrics');
