...
assert(html.includes('assets/css/flow-quality-gate.css?v=1.2.8-header-meta'), 'flow quality gate stylesheet is linked');
assert(loader.includes('src/ui/flow-quality-gate.js?v=${VERSION}-flow-audit'), 'flow quality gate script is staged');
assert(sw.includes('./assets/css/flow-quality-gate.css?v=1.2.8-header-meta'), 'flow quality gate stylesheet is cached');
...
assert(html.includes('data-build="1.2.8"'), 'build marker is v1.2.8');
