...
assert(html.includes('assets/css/flow-quality-gate.css?v=1.1.0-flow-audit'), 'flow quality gate stylesheet is linked');
assert(html.includes('src/ui/flow-quality-gate.js?v=1.1.0-flow-audit'), 'flow quality gate script is linked');
assert(sw.includes('./assets/css/flow-quality-gate.css?v=1.1.0-flow-audit'), 'flow quality gate stylesheet is cached');
assert(sw.includes('./src/ui/flow-quality-gate.js?v=1.1.0-flow-audit'), 'flow quality gate script is cached');
...
assert(html.includes('data-build="1.1.0"'), 'build marker is v1.1.0');
