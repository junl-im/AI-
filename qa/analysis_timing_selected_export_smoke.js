...
const window={document,localStorage:storage,Blob:global.Blob,CustomEvent:function(){},AIShortsRuntimeConfig:{APP_VERSION:'v1.6.24'},AIShortsDownloadService:{saveBlob:(b,n)=>saved.push({b,n})}}; window.window=window;
