...
assert(pkg.version === '1.6.13', 'UI refinement release version is v1.6.13');
assert(html.includes('assets/css/ui-refinement.css?v=1.6.13-transactional-model-pack-qa-controls'), 'UI refinement stylesheet is loaded last');
assert(html.indexOf('ui-refinement.css') > html.indexOf('hero-command-deck.css'), 'UI refinement stylesheet wins the cascade');
assert(sw.includes('./assets/css/ui-refinement.css?v=1.6.13-transactional-model-pack-qa-controls'), 'service worker caches the UI refinement stylesheet');
...
console.log('PASS v1.6.13 unified UI refinement guardrails present');
