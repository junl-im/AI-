...
assert(pkg.version === '1.5.20', 'UI refinement release version is v1.5.20');
assert(html.includes('assets/css/ui-refinement.css?v=1.5.20-structure-responsive-priority'), 'UI refinement stylesheet is loaded last');
assert(html.indexOf('ui-refinement.css') > html.indexOf('hero-command-deck.css'), 'UI refinement stylesheet wins the cascade');
assert(sw.includes('./assets/css/ui-refinement.css?v=1.5.20-structure-responsive-priority'), 'service worker caches the UI refinement stylesheet');
...
console.log('PASS v1.5.20 unified UI refinement guardrails present');
