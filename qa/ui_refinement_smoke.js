...
assert(pkg.version === '1.4.0', 'UI refinement release version is v1.4.0');
assert(html.includes('assets/css/ui-refinement.css?v=1.4.0-adaptive-mobile'), 'UI refinement stylesheet is loaded last');
assert(html.indexOf('ui-refinement.css') > html.indexOf('hero-command-deck.css'), 'UI refinement stylesheet wins the cascade');
assert(sw.includes('./assets/css/ui-refinement.css?v=1.4.0-adaptive-mobile'), 'service worker caches the UI refinement stylesheet');
...
console.log('PASS v1.4.0 unified UI refinement guardrails present');
