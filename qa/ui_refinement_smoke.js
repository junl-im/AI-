...
assert(pkg.version === '1.2.9', 'UI refinement release version is v1.2.9');
assert(html.includes('assets/css/ui-refinement.css?v=1.2.9-stability-audit'), 'UI refinement stylesheet is loaded last');
assert(html.indexOf('ui-refinement.css') > html.indexOf('hero-command-deck.css'), 'UI refinement stylesheet wins the cascade');
assert(sw.includes('./assets/css/ui-refinement.css?v=1.2.9-stability-audit'), 'service worker caches the UI refinement stylesheet');
...
console.log('PASS v1.2.9 unified UI refinement guardrails present');
