...
assert(pkg.version === '1.6.12', 'UI refinement release version is v1.6.12');
assert(html.includes('assets/css/ui-refinement.css?v=1.6.12-model-pack-benchmark-rollback'), 'UI refinement stylesheet is loaded last');
assert(html.indexOf('ui-refinement.css') > html.indexOf('hero-command-deck.css'), 'UI refinement stylesheet wins the cascade');
assert(sw.includes('./assets/css/ui-refinement.css?v=1.6.12-model-pack-benchmark-rollback'), 'service worker caches the UI refinement stylesheet');
...
console.log('PASS v1.6.12 unified UI refinement guardrails present');
