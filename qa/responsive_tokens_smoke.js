...
ok(pkg.version === '1.5.28', 'responsive token release version must be v1.5.28');
for (const token of [
...
console.log('PASS v1.5.28 common responsive geometry tokens and header/stage ownership cleanup');
