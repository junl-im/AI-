...
ok(pkg.version === '1.6.2', 'responsive token release version must be v1.6.2');
for (const token of [
...
console.log('PASS v1.6.2 common responsive geometry tokens and header/stage ownership cleanup');
