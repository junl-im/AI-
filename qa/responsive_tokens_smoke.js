...
ok(pkg.version === '1.5.14', 'responsive token release version must be v1.5.14');
for (const token of [
...
ok(header.includes('grid-template-columns: minmax(0, 1fr) auto !important') && header.includes('align-items: center !important'), 'header metadata rail owns final grid alignment');
...
console.log('PASS v1.5.14 common responsive geometry tokens and header/stage ownership cleanup');
