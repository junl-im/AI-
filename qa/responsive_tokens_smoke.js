...
ok(pkg.version === '1.6.3', 'responsive token release version must be v1.6.3');
for (const token of [
...
console.log('PASS v1.6.3 common responsive geometry tokens and header/stage ownership cleanup');
