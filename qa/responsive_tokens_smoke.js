...
ok(pkg.version === '1.5.27', 'responsive token release version must be v1.5.27');
for (const token of [
...
console.log('PASS v1.5.27 common responsive geometry tokens and header/stage ownership cleanup');
