...
ok(pkg.version === '1.5.25', 'refinement priority release version is v1.5.25');
...
console.log('PASS v1.5.25 inherits the v1.5.18 refinement and foundation priority guardrails');
