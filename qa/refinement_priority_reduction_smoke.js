...
ok(pkg.version === '1.6.15', 'refinement priority release version is v1.6.15');
...
console.log('PASS v1.6.15 inherits the v1.5.18 refinement and foundation priority guardrails');
