...
ok(pkg.version === '1.6.2', 'refinement priority release version is v1.6.2');
...
console.log('PASS v1.6.2 inherits the v1.5.18 refinement and foundation priority guardrails');
