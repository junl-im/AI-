...
ok(pkg.version === '1.5.20', 'refinement priority release version is v1.5.20');
...
console.log('PASS v1.5.20 inherits the v1.5.18 refinement and foundation priority guardrails');
