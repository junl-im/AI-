...
assert(pkg.version === '1.3.5', 'adaptive mobile menu release version is v1.3.5');
...
assert(html.includes('assets/css/mobile-menu-guide.css?v=1.3.5-adaptive-mobile'), 'adaptive mobile menu stylesheet is linked');
assert(html.includes('src/ui/mobile-menu-guide.js?v=1.3.5-adaptive-mobile'), 'adaptive mobile menu controller is linked');
...
assert(sw.includes('./assets/css/mobile-menu-guide.css?v=1.3.5-adaptive-mobile') && sw.includes('./src/ui/mobile-menu-guide.js?v=1.3.5-adaptive-mobile'), 'service worker caches adaptive mobile menu assets');
console.log('PASS v1.3.5 adaptive mobile current/next menu guardrails');
