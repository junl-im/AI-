...
assert(pkg.version === '1.5.24', 'adaptive mobile menu release version is v1.5.24');
...
assert(html.includes('assets/css/mobile-menu-guide.css?v=1.5.24-compressed-session-integrity-rollback'), 'adaptive mobile menu stylesheet is linked');
assert(html.includes('src/ui/mobile-menu-guide.js?v=1.5.24-compressed-session-integrity-rollback'), 'adaptive mobile menu controller is linked');
...
assert(sw.includes('./assets/css/mobile-menu-guide.css?v=1.5.24-compressed-session-integrity-rollback') && sw.includes('./src/ui/mobile-menu-guide.js?v=1.5.24-compressed-session-integrity-rollback'), 'service worker caches adaptive mobile menu assets');
console.log('PASS v1.5.24 adaptive mobile current/next menu guardrails');
