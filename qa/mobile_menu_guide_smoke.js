...
assert(pkg.version === '1.5.6', 'adaptive mobile menu release version is v1.5.6');
...
assert(html.includes('assets/css/mobile-menu-guide.css?v=1.5.6-ui-clarity'), 'adaptive mobile menu stylesheet is linked');
assert(html.includes('src/ui/mobile-menu-guide.js?v=1.5.6-ui-clarity'), 'adaptive mobile menu controller is linked');
...
assert(sw.includes('./assets/css/mobile-menu-guide.css?v=1.5.6-ui-clarity') && sw.includes('./src/ui/mobile-menu-guide.js?v=1.5.6-ui-clarity'), 'service worker caches adaptive mobile menu assets');
console.log('PASS v1.5.6 adaptive mobile current/next menu guardrails');
