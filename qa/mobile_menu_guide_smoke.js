...
assert(pkg.version === '1.5.28', 'adaptive mobile menu release version is v1.5.28');
...
assert(html.includes('assets/css/mobile-menu-guide.css?v=1.5.28-analysis-namespace-maintenance-history'), 'adaptive mobile menu stylesheet is linked');
assert(html.includes('src/ui/mobile-menu-guide.js?v=1.5.28-analysis-namespace-maintenance-history'), 'adaptive mobile menu controller is linked');
...
assert(sw.includes('./assets/css/mobile-menu-guide.css?v=1.5.28-analysis-namespace-maintenance-history') && sw.includes('./src/ui/mobile-menu-guide.js?v=1.5.28-analysis-namespace-maintenance-history'), 'service worker caches adaptive mobile menu assets');
console.log('PASS v1.5.28 adaptive mobile current/next menu guardrails');
