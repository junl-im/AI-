...
assert(pkg.version === '1.6.4', 'adaptive mobile menu release version is v1.6.4');
...
assert(html.includes('assets/css/mobile-menu-guide.css?v=1.6.4-recovery-loop-impact-preview'), 'adaptive mobile menu stylesheet is linked');
assert(html.includes('src/ui/mobile-menu-guide.js?v=1.6.4-recovery-loop-impact-preview'), 'adaptive mobile menu controller is linked');
...
assert(sw.includes('./assets/css/mobile-menu-guide.css?v=1.6.4-recovery-loop-impact-preview') && sw.includes('./src/ui/mobile-menu-guide.js?v=1.6.4-recovery-loop-impact-preview'), 'service worker caches adaptive mobile menu assets');
console.log('PASS v1.6.4 adaptive mobile current/next menu guardrails');
