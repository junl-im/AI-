...
assert(pkg.version === '1.6.9', 'adaptive mobile menu release version is v1.6.9');
...
assert(html.includes('assets/css/mobile-menu-guide.css?v=1.6.9-direct-crop-editor'), 'adaptive mobile menu stylesheet is linked');
assert(html.includes('src/ui/mobile-menu-guide.js?v=1.6.9-direct-crop-editor'), 'adaptive mobile menu controller is linked');
...
assert(sw.includes('./assets/css/mobile-menu-guide.css?v=1.6.9-direct-crop-editor') && sw.includes('./src/ui/mobile-menu-guide.js?v=1.6.9-direct-crop-editor'), 'service worker caches adaptive mobile menu assets');
console.log('PASS v1.6.9 adaptive mobile current/next menu guardrails');
