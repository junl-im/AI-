...
(async () => {
    ...
    ok(mediaImport.includes("type: 'unsupported-media'"), 'unsupported media rejection is wired into import flow');
    ...
    console.log('PASS v1.5.29 runtime registration, media intake, and user-text safety guardrails');
})().catch(error => {
