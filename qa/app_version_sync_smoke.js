...
assert(config.includes(`BUILD_KEY: '${plain}-editorial-masthead'`), 'runtime config build key is updated');
...
assert(sw.includes(`ai-shorts-studio-shell-${version}-editorial-masthead`), 'service worker cache name matches the runtime stability build');
