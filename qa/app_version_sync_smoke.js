...
assert(config.includes(`BUILD_KEY: '${plain}-shorts-pulse-hero'`), 'runtime config build key is updated');
...
assert(sw.includes(`ai-shorts-studio-shell-${version}-shorts-pulse-hero`), 'service worker cache name matches the runtime stability build');
