...
assert(config.includes(`BUILD_KEY: '${plain}-hero-command-deck'`), 'runtime config build key is updated');
...
assert(sw.includes(`ai-shorts-studio-shell-${version}-hero-command-deck`), 'service worker cache name matches the runtime stability build');
