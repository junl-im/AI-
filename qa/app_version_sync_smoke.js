...
const buildKey = `${plain}-responsive-density`;
...
assert(sw.includes(`ai-shorts-studio-shell-${version}-responsive-density`), 'service worker cache name matches the current build');
