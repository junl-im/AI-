...
assert(html.includes('assets/css/responsive-workspace.css?v=1.6.13-transactional-model-pack-qa-controls'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.6.13-transactional-model-pack-qa-controls'), 'responsive workspace stylesheet is cached');
