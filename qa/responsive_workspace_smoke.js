...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'responsive workspace stylesheet is cached');
