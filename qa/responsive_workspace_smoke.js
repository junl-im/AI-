...
assert(html.includes('assets/css/responsive-workspace.css?v=1.6.0-local-ai-provider-foundation'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.6.0-local-ai-provider-foundation'), 'responsive workspace stylesheet is cached');
