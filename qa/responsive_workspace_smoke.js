...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.4-css-ownership'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.4-css-ownership'), 'responsive workspace stylesheet is cached');
