...
assert(html.includes('assets/css/responsive-workspace.css?v=1.6.9-direct-crop-editor'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.6.9-direct-crop-editor'), 'responsive workspace stylesheet is cached');
