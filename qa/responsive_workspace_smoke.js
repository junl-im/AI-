...
assert(html.includes('assets/css/responsive-workspace.css?v=1.0.3-flow-audit'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.0.3-flow-audit'), 'responsive workspace stylesheet is cached');
