...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'responsive workspace stylesheet is cached');
