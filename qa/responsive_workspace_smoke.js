...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.3-media-engine'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.3-media-engine'), 'responsive workspace stylesheet is cached');
