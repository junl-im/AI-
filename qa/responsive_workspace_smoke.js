...
assert(html.includes('assets/css/responsive-workspace.css?v=1.3.6-adaptive-mobile'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.3.6-adaptive-mobile'), 'responsive workspace stylesheet is cached');
