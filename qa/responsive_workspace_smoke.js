...
assert(html.includes('assets/css/responsive-workspace.css?v=1.6.3-stage-focus-progressive-disclosure'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.6.3-stage-focus-progressive-disclosure'), 'responsive workspace stylesheet is cached');
