...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.28-analysis-namespace-maintenance-history'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.28-analysis-namespace-maintenance-history'), 'responsive workspace stylesheet is cached');
