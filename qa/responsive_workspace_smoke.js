...
assert(html.includes('assets/css/responsive-workspace.css?v=1.6.12-model-pack-benchmark-rollback'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.6.12-model-pack-benchmark-rollback'), 'responsive workspace stylesheet is cached');
