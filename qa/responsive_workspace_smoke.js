...
assert(html.includes('assets/css/responsive-workspace.css?v=1.6.2-layout-harmony-footer-health'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.6.2-layout-harmony-footer-health'), 'responsive workspace stylesheet is cached');
