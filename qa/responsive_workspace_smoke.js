...
assert(html.includes('assets/css/responsive-workspace.css?v=1.3.0-stage-beacon'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.3.0-stage-beacon'), 'responsive workspace stylesheet is cached');
