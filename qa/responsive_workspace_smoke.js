...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.5-mobile-control-ownership'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.5-mobile-control-ownership'), 'responsive workspace stylesheet is cached');
