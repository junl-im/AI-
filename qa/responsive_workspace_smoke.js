...
assert(html.includes('assets/css/responsive-workspace.css?v=1.2.8-header-meta'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.2.8-header-meta'), 'responsive workspace stylesheet is cached');
