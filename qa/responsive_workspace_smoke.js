...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.29-analysis-signature-storage-trend'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.29-analysis-signature-storage-trend'), 'responsive workspace stylesheet is cached');
