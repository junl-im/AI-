...
assert(html.includes('assets/css/responsive-workspace.css?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'responsive workspace stylesheet is cached');
