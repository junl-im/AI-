...
assert(html.includes('assets/css/responsive-workspace.css?v=1.6.1-advanced-diagnostics-gate'), 'responsive workspace stylesheet is linked');
assert(sw.includes('responsive-workspace.css?v=1.6.1-advanced-diagnostics-gate'), 'responsive workspace stylesheet is cached');
