...
ok(pkg.version === '1.5.27', 'control ownership release version is v1.5.27');
...
console.log('PASS v1.5.27 command/control ownership and retired command-group cleanup');
