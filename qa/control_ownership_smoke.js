...
ok(pkg.version === '1.5.25', 'control ownership release version is v1.5.25');
...
console.log('PASS v1.5.25 command/control ownership and retired command-group cleanup');
