...
ok(pkg.version === '1.5.24', 'control ownership release version is v1.5.24');
...
console.log('PASS v1.5.24 command/control ownership and retired command-group cleanup');
