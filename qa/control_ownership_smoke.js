...
ok(pkg.version === '1.6.12', 'control ownership release version is v1.6.12');
...
console.log('PASS v1.6.12 command/control ownership and retired command-group cleanup');
