...
ok(pkg.version === '1.5.26', 'control ownership release version is v1.5.26');
...
console.log('PASS v1.5.26 command/control ownership and retired command-group cleanup');
