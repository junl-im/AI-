...
ok(pkg.version === '1.5.28', 'control ownership release version is v1.5.28');
...
console.log('PASS v1.5.28 command/control ownership and retired command-group cleanup');
