...
ok(pkg.version === '1.5.29', 'control ownership release version is v1.5.29');
...
console.log('PASS v1.5.29 command/control ownership and retired command-group cleanup');
