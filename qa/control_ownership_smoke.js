...
ok(pkg.version === '1.5.17', 'control ownership release version is v1.5.17');
...
console.log('PASS v1.5.17 command/control ownership and retired command-group cleanup');
