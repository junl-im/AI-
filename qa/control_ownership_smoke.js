...
ok(pkg.version === '1.5.20', 'control ownership release version is v1.5.20');
...
console.log('PASS v1.5.20 command/control ownership and retired command-group cleanup');
