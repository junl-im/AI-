...
ok(pkg.version === '1.6.13', 'control ownership release version is v1.6.13');
...
console.log('PASS v1.6.13 command/control ownership and retired command-group cleanup');
