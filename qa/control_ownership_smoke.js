...
ok(pkg.version === '1.5.16', 'control ownership release version is v1.5.16');
...
console.log('PASS v1.5.16 command/control ownership and retired command-group cleanup');
