...
ok(pkg.version === '1.5.14', 'control ownership release version is v1.5.14');
...
console.log('PASS v1.5.14 command/control ownership and retired command-group cleanup');
