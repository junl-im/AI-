...
ok(pkg.version === '1.6.15', 'control ownership release version is v1.6.15');
...
console.log('PASS v1.6.15 command/control ownership and retired command-group cleanup');
