...
if (releaseVersion !== '1.6.1') throw new Error('heap stability inheritance contract must be reviewed for this release');
...
console.log('PASS v1.6.1 inherits the unchanged v1.5.3 20-cycle heap and Object URL stability audit');
