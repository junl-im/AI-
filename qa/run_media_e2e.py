#!/usr/bin/env python3
"""Optional real-media Chromium audit for AI Shorts Studio v1.3.6.
...
OUTPUT = ROOT / 'qa' / 'runtime-media-e2e-v1.3.6.json'
...
def parse_args():
    ...
    parser.add_argument('--reset', action='store_true', help='Discard the existing v1.3.6 audit before running.')
