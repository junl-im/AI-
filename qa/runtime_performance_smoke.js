...
assert(pkg.version === '1.5.3', 'runtime polish package version is v1.5.3');
assert(html.includes('assets/css/foundation-polish.css?v=1.5.3-media-engine'), 'foundation polish stylesheet is linked');
assert(html.includes('src/ui/startup-performance.js?v=1.5.3-media-engine'), 'startup performance module is linked');
assert(sw.includes('foundation-polish.css?v=1.5.3-media-engine'), 'foundation polish stylesheet is cached');
assert(sw.includes('startup-performance.js?v=1.5.3-media-engine'), 'startup performance module is cached');
...
console.log('PASS v1.5.3 runtime performance and startup hierarchy guardrails present');
