...
ok(pkg.version === '1.5.24', 'responsive density release version must be v1.5.24');
...
console.log('PASS v1.5.24 tablet and small-laptop responsive density ownership guardrails');
