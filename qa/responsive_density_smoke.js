...
ok(pkg.version === '1.5.26', 'responsive density release version must be v1.5.26');
...
console.log('PASS v1.5.26 tablet and small-laptop responsive density ownership guardrails');
