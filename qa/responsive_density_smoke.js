...
ok(pkg.version === '1.6.2', 'responsive density release version must be v1.6.2');
...
console.log('PASS v1.6.2 tablet and small-laptop responsive density ownership guardrails');
