...
ok(pkg.version === '1.5.29', 'responsive density release version must be v1.5.29');
...
console.log('PASS v1.5.29 tablet and small-laptop responsive density ownership guardrails');
