...
ok(pkg.version === '1.5.25', 'responsive density release version must be v1.5.25');
...
console.log('PASS v1.5.25 tablet and small-laptop responsive density ownership guardrails');
