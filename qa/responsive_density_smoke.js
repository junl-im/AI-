...
ok(/^1\.6\.\d+$/.test(pkg.version), 'responsive density release version must be v1.6.25');
...
console.log('PASS v1.6.25 tablet and small-laptop responsive density ownership guardrails');
