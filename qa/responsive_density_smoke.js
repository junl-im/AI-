...
ok(pkg.version === '1.6.12', 'responsive density release version must be v1.6.12');
...
console.log('PASS v1.6.12 tablet and small-laptop responsive density ownership guardrails');
