...
ok(pkg.version === '1.6.1', 'responsive density release version must be v1.6.1');
...
console.log('PASS v1.6.1 tablet and small-laptop responsive density ownership guardrails');
