...
ok(pkg.version === '1.5.20', 'responsive density release version must be v1.5.20');
...
console.log('PASS v1.5.20 tablet and small-laptop responsive density ownership guardrails');
