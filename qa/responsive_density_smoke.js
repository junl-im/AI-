...
ok(pkg.version === '1.6.0', 'responsive density release version must be v1.6.0');
...
console.log('PASS v1.6.0 tablet and small-laptop responsive density ownership guardrails');
