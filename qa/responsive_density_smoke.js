...
ok(pkg.version === '1.6.13', 'responsive density release version must be v1.6.13');
...
console.log('PASS v1.6.13 tablet and small-laptop responsive density ownership guardrails');
