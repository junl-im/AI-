...
ok(pkg.version === '1.6.5', 'responsive density release version must be v1.6.5');
...
console.log('PASS v1.6.5 tablet and small-laptop responsive density ownership guardrails');
