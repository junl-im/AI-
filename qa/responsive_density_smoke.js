...
ok(pkg.version === '1.6.4', 'responsive density release version must be v1.6.4');
...
console.log('PASS v1.6.4 tablet and small-laptop responsive density ownership guardrails');
