...
ok(pkg.version === '1.6.15', 'responsive density release version must be v1.6.15');
...
console.log('PASS v1.6.15 tablet and small-laptop responsive density ownership guardrails');
