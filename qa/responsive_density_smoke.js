...
ok(pkg.version === '1.5.27', 'responsive density release version must be v1.5.27');
...
console.log('PASS v1.5.27 tablet and small-laptop responsive density ownership guardrails');
