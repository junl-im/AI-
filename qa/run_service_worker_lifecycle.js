...
const output = path.join(root, 'qa', 'runtime-service-worker-lifecycle-v1.6.3.json');
...
(async () => {
    ...
    const currentName = [...cacheStores.keys()].find(name => name.includes('v1.6.3-stage-focus-progressive-disclosure'));
