...
const output = path.join(root, 'qa', 'runtime-service-worker-lifecycle-v1.6.9.json');
...
(async () => {
    ...
    const currentName = [...cacheStores.keys()].find(name => name.includes('v1.6.9-direct-crop-editor'));
