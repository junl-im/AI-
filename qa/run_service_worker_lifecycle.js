...
const output = path.join(root, 'qa', 'runtime-service-worker-lifecycle-v1.5.25.json');
...
(async () => {
    ...
    const currentName = [...cacheStores.keys()].find(name => name.includes('v1.5.25-persistent-analysis-selective-recovery-integrity-audit'));
