...
const output = path.join(root, 'qa', 'runtime-service-worker-lifecycle-v1.5.14.json');
...
(async () => {
    ...
    const currentName = [...cacheStores.keys()].find(name => name.includes('v1.5.14-cascade-dedup'));
