...
assert(pkg.version === '1.5.2', 'render ETA release version is v1.5.2');
...
assert(css.includes('v1.5.2 long-media render ETA'), 'render ETA layout has responsive styling');
console.log('PASS v1.5.2 throttled render ETA guardrails');
