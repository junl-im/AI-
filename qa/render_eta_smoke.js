...
assert(pkg.version === '1.5.7', 'render ETA release version is v1.5.7');
...
assert(css.includes('v1.5.7 long-media render ETA'), 'render ETA layout has responsive styling');
console.log('PASS v1.5.7 throttled render ETA guardrails');
