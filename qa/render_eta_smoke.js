...
assert(pkg.version === '1.4.0', 'render ETA release version is v1.4.0');
...
assert(css.includes('v1.4.0 long-media render ETA'), 'render ETA layout has responsive styling');
console.log('PASS v1.4.0 throttled render ETA guardrails');
