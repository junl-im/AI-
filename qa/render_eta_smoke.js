...
assert(pkg.version === '1.3.5', 'render ETA release version is v1.3.5');
...
assert(css.includes('v1.3.5 long-media render ETA'), 'render ETA layout has responsive styling');
console.log('PASS v1.3.5 throttled render ETA guardrails');
