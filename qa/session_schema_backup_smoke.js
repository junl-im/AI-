...
const window = {
    ...
    AIShortsRuntimeConfig: { APP_VERSION: 'v1.6.0', BUILD_KEY: '1.6.0-local-ai-provider-foundation', SESSION_SCHEMA_VERSION: 4, SESSION_BACKUP_COUNT: 2, SESSION_BACKUP_MAX_CHARS: 750000 },
