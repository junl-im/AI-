...
if (!html.includes('assets/css/icon-system.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit')) throw new Error('icon stylesheet not loaded');
