...
ok(pkg.version === '1.6.13', 'workflow focus release version is v1.6.13');
...
ok(html.includes('assets/css/workflow-focus-layout.css?v=1.6.13-transactional-model-pack-qa-controls'), 'workflow focus stylesheet is loaded last in layout ownership');
...
ok(sw.includes('./assets/css/workflow-focus-layout.css?v=1.6.13-transactional-model-pack-qa-controls') && sw.includes('./src/ui/workflow-focus-layout.js?v=1.6.13-transactional-model-pack-qa-controls'), 'service worker caches stage focus assets');
...
console.log('PASS v1.6.13 stage-aware progressive disclosure, reversible full view, and measured dock clearance');
