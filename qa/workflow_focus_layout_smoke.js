...
ok(pkg.version === '1.6.24', 'workflow focus release version is v1.6.20');
...
console.log('PASS v1.6.24 stage-aware progressive disclosure, reversible full view, and measured dock clearance');
