...
ok(pkg.version === '1.6.4', 'workflow focus release version is v1.6.4');
...
ok(html.includes('assets/css/workflow-focus-layout.css?v=1.6.4-recovery-loop-impact-preview'), 'workflow focus stylesheet is loaded last in layout ownership');
...
ok(sw.includes('./assets/css/workflow-focus-layout.css?v=1.6.4-recovery-loop-impact-preview') && sw.includes('./src/ui/workflow-focus-layout.js?v=1.6.4-recovery-loop-impact-preview'), 'service worker caches stage focus assets');
...
console.log('PASS v1.6.4 stage-aware progressive disclosure, reversible full view, and measured dock clearance');
