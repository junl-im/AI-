...
assert(pkg.version === '1.5.28', 'audio fallback release version is v1.5.28');
assert(html.includes('audio-analysis-core.js?v=1.5.28-analysis-namespace-maintenance-history') && html.indexOf('audio-analysis-core.js') < html.indexOf('audio-feature-extractor.js'), 'shared audio core loads before the extractor');
assert(sw.includes('audio-analysis-core.js?v=1.5.28-analysis-namespace-maintenance-history'), 'service worker caches the shared audio core');
...
console.log('PASS v1.5.28 shared audio analyzer and worker fallback guardrails');
