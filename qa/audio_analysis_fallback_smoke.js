...
assert(pkg.version === '1.5.7', 'audio fallback release version is v1.5.7');
assert(html.includes('audio-analysis-core.js?v=1.5.7-responsive-density') && html.indexOf('audio-analysis-core.js') < html.indexOf('audio-feature-extractor.js'), 'shared audio core loads before the extractor');
assert(sw.includes('audio-analysis-core.js?v=1.5.7-responsive-density'), 'service worker caches the shared audio core');
...
console.log('PASS v1.5.7 shared audio analyzer and worker fallback guardrails');
