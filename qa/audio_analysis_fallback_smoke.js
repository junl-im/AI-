...
assert(pkg.version === '1.6.1', 'audio fallback release version is v1.6.1');
assert(html.includes('audio-analysis-core.js?v=1.6.1-advanced-diagnostics-gate') && html.indexOf('audio-analysis-core.js') < html.indexOf('audio-feature-extractor.js'), 'shared audio core loads before the extractor');
assert(sw.includes('audio-analysis-core.js?v=1.6.1-advanced-diagnostics-gate'), 'service worker caches the shared audio core');
...
console.log('PASS v1.6.1 shared audio analyzer and worker fallback guardrails');
