...
assert(pkg.version === '1.5.6', 'audio fallback release version is v1.5.6');
assert(html.includes('audio-analysis-core.js?v=1.5.6-ui-clarity') && html.indexOf('audio-analysis-core.js') < html.indexOf('audio-feature-extractor.js'), 'shared audio core loads before the extractor');
assert(sw.includes('audio-analysis-core.js?v=1.5.6-ui-clarity'), 'service worker caches the shared audio core');
...
console.log('PASS v1.5.6 shared audio analyzer and worker fallback guardrails');
