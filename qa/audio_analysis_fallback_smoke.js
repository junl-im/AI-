...
assert(pkg.version === '1.3.4', 'audio fallback release version is v1.3.4');
assert(html.includes('audio-analysis-core.js?v=1.3.4-adaptive-mobile') && html.indexOf('audio-analysis-core.js') < html.indexOf('audio-feature-extractor.js'), 'shared audio core loads before the extractor');
assert(sw.includes('audio-analysis-core.js?v=1.3.4-adaptive-mobile'), 'service worker caches the shared audio core');
...
console.log('PASS v1.3.4 shared audio analyzer and worker fallback guardrails');
