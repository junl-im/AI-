...
['module-contracts.js?v=1.3.2-media-e2e', 'analysis-cache.js?v=1.3.2-media-e2e', 'pro-engine-tuner.js?v=1.3.2-media-e2e', 'stability-auditor.js?v=1.3.2-media-e2e'].forEach(token => {
