...
['module-contracts.js?v=1.1.9-flow-audit', 'analysis-cache.js?v=1.1.9-flow-audit', 'pro-engine-tuner.js?v=1.1.9-flow-audit', 'stability-auditor.js?v=1.1.9-flow-audit'].forEach(token => {
