...
['module-contracts.js?v=1.6.15-preview-cache-diagnostics', 'analysis-cache.js?v=1.6.15-preview-cache-diagnostics', 'pro-engine-tuner.js?v=1.6.15-preview-cache-diagnostics', 'stability-auditor.js?v=1.6.15-preview-cache-diagnostics'].forEach(token => {
