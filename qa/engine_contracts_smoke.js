...
['module-contracts.js?v=0.9.7-flow-hotfix', 'analysis-cache.js?v=0.9.7-flow-hotfix', 'pro-engine-tuner.js?v=0.9.7-flow-hotfix', 'stability-auditor.js?v=0.9.7-flow-hotfix'].forEach(token => {
