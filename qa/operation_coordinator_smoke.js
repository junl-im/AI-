...
assert(html.includes('src/engine/operation-coordinator.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'operation coordinator is loaded');
