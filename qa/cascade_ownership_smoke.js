...
assert(pkg.version === '1.6.13', 'cascade ownership release version is v1.6.13');
...
console.log('PASS v1.6.13 zero-conflict geometry, token, and fallback ownership guardrails');
