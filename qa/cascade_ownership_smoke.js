...
assert(pkg.version === '1.5.14', 'cascade ownership release version is v1.5.14');
...
assert(report.importantCount <= 824, 'important declaration ceiling is preserved');
console.log('PASS v1.5.14 zero-conflict geometry, token, and fallback ownership guardrails');
