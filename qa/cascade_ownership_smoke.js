...
assert(pkg.version === '1.6.0', 'cascade ownership release version is v1.6.0');
...
console.log('PASS v1.6.0 zero-conflict geometry, token, and fallback ownership guardrails');
