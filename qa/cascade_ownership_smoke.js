...
assert(pkg.version === '1.5.29', 'cascade ownership release version is v1.5.29');
...
console.log('PASS v1.5.29 zero-conflict geometry, token, and fallback ownership guardrails');
