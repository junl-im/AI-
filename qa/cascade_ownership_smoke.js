...
assert(pkg.version === '1.6.4', 'cascade ownership release version is v1.6.4');
...
console.log('PASS v1.6.4 zero-conflict geometry, token, and fallback ownership guardrails');
