...
assert(pkg.version === '1.5.26', 'cascade ownership release version is v1.5.26');
...
console.log('PASS v1.5.26 zero-conflict geometry, token, and fallback ownership guardrails');
