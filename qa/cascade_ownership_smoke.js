...
assert(pkg.version === '1.6.1', 'cascade ownership release version is v1.6.1');
...
console.log('PASS v1.6.1 zero-conflict geometry, token, and fallback ownership guardrails');
