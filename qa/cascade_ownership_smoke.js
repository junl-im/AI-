...
assert(pkg.version === '1.6.5', 'cascade ownership release version is v1.6.5');
...
console.log('PASS v1.6.5 zero-conflict geometry, token, and fallback ownership guardrails');
