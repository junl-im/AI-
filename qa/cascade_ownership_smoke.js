...
assert(pkg.version === '1.6.12', 'cascade ownership release version is v1.6.12');
...
console.log('PASS v1.6.12 zero-conflict geometry, token, and fallback ownership guardrails');
