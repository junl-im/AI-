...
assert(pkg.version === '1.5.28', 'cascade ownership release version is v1.5.28');
...
console.log('PASS v1.5.28 zero-conflict geometry, token, and fallback ownership guardrails');
