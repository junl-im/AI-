...
assert(pkg.version === '1.5.25', 'cascade ownership release version is v1.5.25');
...
console.log('PASS v1.5.25 zero-conflict geometry, token, and fallback ownership guardrails');
