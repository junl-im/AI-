...
assert(pkg.version === '1.6.2', 'cascade ownership release version is v1.6.2');
...
console.log('PASS v1.6.2 zero-conflict geometry, token, and fallback ownership guardrails');
