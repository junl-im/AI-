...
assert(pkg.version === '1.6.15', 'cascade ownership release version is v1.6.15');
...
console.log('PASS v1.6.15 zero-conflict geometry, token, and fallback ownership guardrails');
