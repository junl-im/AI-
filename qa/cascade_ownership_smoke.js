...
assert(pkg.version === '1.5.16', 'cascade ownership release version is v1.5.16');
...
assert(report.importantCount <= 801, 'important declaration ceiling is preserved');
console.log('PASS v1.5.16 zero-conflict geometry, token, and fallback ownership guardrails');
