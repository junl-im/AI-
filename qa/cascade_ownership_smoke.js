...
assert(pkg.version === '1.6.3', 'cascade ownership release version is v1.6.3');
...
console.log('PASS v1.6.3 zero-conflict geometry, token, and fallback ownership guardrails');
