...
assert(pkg.version === '1.5.20', 'cascade ownership release version is v1.5.20');
...
console.log('PASS v1.5.20 zero-conflict geometry, token, and fallback ownership guardrails');
