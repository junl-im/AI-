...
assert(pkg.version === '1.5.27', 'cascade ownership release version is v1.5.27');
...
console.log('PASS v1.5.27 zero-conflict geometry, token, and fallback ownership guardrails');
