...
assert(pkg.version === '1.5.24', 'cascade ownership release version is v1.5.24');
...
console.log('PASS v1.5.24 zero-conflict geometry, token, and fallback ownership guardrails');
