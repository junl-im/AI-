...
assert(pkg.version === '1.5.17', 'cascade ownership release version is v1.5.17');
...
console.log('PASS v1.5.17 zero-conflict geometry, token, and fallback ownership guardrails');
