...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.13-transactional-model-pack-qa-controls'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.13-transactional-model-pack-qa-controls'), 'service worker caches glass stylesheet');
