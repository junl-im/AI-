...
const sw = read('sw.js');
assert(html.includes(`assets/css/glass-pro-ui.css?v=${buildKey}`), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes(`./assets/css/glass-pro-ui.css?v=${buildKey}`), 'service worker caches glass stylesheet');
