...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.5.28-analysis-namespace-maintenance-history'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.5.28-analysis-namespace-maintenance-history'), 'service worker caches glass stylesheet');
