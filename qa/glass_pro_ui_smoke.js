...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.3.7-adaptive-mobile'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.3.7-adaptive-mobile'), 'service worker caches glass stylesheet');
