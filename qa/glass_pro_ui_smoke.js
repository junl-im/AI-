...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.9-direct-crop-editor'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.9-direct-crop-editor'), 'service worker caches glass stylesheet');
