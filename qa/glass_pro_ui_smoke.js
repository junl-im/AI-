...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.4-recovery-loop-impact-preview'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.4-recovery-loop-impact-preview'), 'service worker caches glass stylesheet');
