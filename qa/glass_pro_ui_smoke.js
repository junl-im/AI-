...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.1-advanced-diagnostics-gate'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.1-advanced-diagnostics-gate'), 'service worker caches glass stylesheet');
