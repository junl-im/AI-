...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.0-local-ai-provider-foundation'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.0-local-ai-provider-foundation'), 'service worker caches glass stylesheet');
