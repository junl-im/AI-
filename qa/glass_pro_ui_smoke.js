...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.5.29-analysis-signature-storage-trend'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.5.29-analysis-signature-storage-trend'), 'service worker caches glass stylesheet');
