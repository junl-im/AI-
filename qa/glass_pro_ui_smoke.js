...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.5-smart-reframe-caption-safe'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.5-smart-reframe-caption-safe'), 'service worker caches glass stylesheet');
