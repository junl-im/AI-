...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.12-model-pack-benchmark-rollback'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.12-model-pack-benchmark-rollback'), 'service worker caches glass stylesheet');
