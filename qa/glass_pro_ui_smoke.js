...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'service worker caches glass stylesheet');
