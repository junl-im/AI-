...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.6.3-stage-focus-progressive-disclosure'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.6.3-stage-focus-progressive-disclosure'), 'service worker caches glass stylesheet');
