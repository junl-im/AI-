...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(refinement.includes('min-height: 60px') && foundation.includes('min-height: 58px'), 'dock geometry remains readable in final ownership layers');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'service worker caches glass stylesheet');
