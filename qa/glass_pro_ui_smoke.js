...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.3.2-media-e2e'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.3.2-media-e2e'), 'service worker caches glass stylesheet');
