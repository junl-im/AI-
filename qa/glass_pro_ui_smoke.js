...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.3.1-workspace-control'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.3.1-workspace-control'), 'service worker caches glass stylesheet');
