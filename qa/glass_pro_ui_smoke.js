...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'service worker caches glass stylesheet');
