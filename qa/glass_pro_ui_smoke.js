...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.5.24-compressed-session-integrity-rollback'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.5.24-compressed-session-integrity-rollback'), 'service worker caches glass stylesheet');
