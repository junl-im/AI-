...
const sw = read('sw.js');
assert(html.includes('assets/css/glass-pro-ui.css?v=1.1.5-glass-pro'), 'glass pro stylesheet is loaded after layout fixes');
...
assert(sw.includes('./assets/css/glass-pro-ui.css?v=1.1.5-glass-pro'), 'service worker caches glass stylesheet');
