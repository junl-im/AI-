...
ok(pkg.version === '1.6.4', 'interaction-state priority release version is v1.6.4');
...
console.log('PASS v1.6.4 interaction-state priority reduction with unchanged computed states');
