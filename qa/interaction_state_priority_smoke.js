...
ok(pkg.version === '1.5.29', 'interaction-state priority release version is v1.5.29');
...
console.log('PASS v1.5.29 interaction-state priority reduction with unchanged computed states');
