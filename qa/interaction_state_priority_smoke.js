...
ok(pkg.version === '1.5.28', 'interaction-state priority release version is v1.5.28');
...
console.log('PASS v1.5.28 interaction-state priority reduction with unchanged computed states');
