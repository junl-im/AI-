...
ok(pkg.version === '1.5.20', 'interaction-state priority release version is v1.5.20');
...
console.log('PASS v1.5.20 interaction-state priority reduction with unchanged computed states');
