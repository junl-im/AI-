...
ok(pkg.version === '1.6.5', 'interaction-state priority release version is v1.6.5');
...
console.log('PASS v1.6.5 interaction-state priority reduction with unchanged computed states');
