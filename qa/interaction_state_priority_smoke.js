...
ok(/^1\.6\.\d+$/.test(pkg.version), 'interaction-state priority release version is v1.6.25');
...
console.log('PASS v1.6.25 interaction-state priority reduction with unchanged computed states');
