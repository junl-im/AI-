...
assert(pkg.version === '1.5.25', 'staged hydration release version is v1.5.25');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.25 staged UI hydration guardrails present');
