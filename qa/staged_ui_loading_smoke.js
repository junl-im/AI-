...
assert(pkg.version === '1.6.13', 'staged hydration release version is v1.6.13');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.6.13-transactional-model-pack-qa-controls'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.6.13-transactional-model-pack-qa-controls'), 'service worker caches the staged loader');
...
console.log('PASS v1.6.13 staged UI hydration guardrails present');
