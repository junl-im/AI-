...
assert(pkg.version === '1.3.2', 'staged hydration release version is v1.3.2');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.3.2-media-e2e'), 'staged UI loader is on the critical path');
assert(directScripts <= 42, `direct startup scripts are reduced to ${directScripts}`);
...
assert(sw.includes('staged-ui-loader.js?v=1.3.2-media-e2e'), 'service worker caches the staged loader');
...
console.log('PASS v1.3.2 staged UI hydration guardrails present');
