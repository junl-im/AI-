...
assert(pkg.version === '1.5.17', 'staged hydration release version is v1.5.17');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.17-important-cascade-reduction'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.17-important-cascade-reduction'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.17 staged UI hydration guardrails present');
