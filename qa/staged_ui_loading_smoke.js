...
assert(pkg.version === '1.6.0', 'staged hydration release version is v1.6.0');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.6.0-local-ai-provider-foundation'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.6.0-local-ai-provider-foundation'), 'service worker caches the staged loader');
...
console.log('PASS v1.6.0 staged UI hydration guardrails present');
