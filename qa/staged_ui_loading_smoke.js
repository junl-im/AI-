...
assert(pkg.version === '1.5.2', 'staged hydration release version is v1.5.2');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.2-experience-engine'), 'staged UI loader is on the critical path');
assert(directScripts <= 47, `direct startup scripts are reduced to ${directScripts}`);
...
assert(sw.includes('staged-ui-loader.js?v=1.5.2-experience-engine'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.2 staged UI hydration guardrails present');
