...
assert(pkg.version === '1.5.14', 'staged hydration release version is v1.5.14');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.14-cascade-dedup'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.14-cascade-dedup'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.14 staged UI hydration guardrails present');
