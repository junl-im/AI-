...
assert(pkg.version === '1.5.27', 'staged hydration release version is v1.5.27');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.27 staged UI hydration guardrails present');
