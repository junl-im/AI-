...
assert(pkg.version === '1.5.26', 'staged hydration release version is v1.5.26');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.26 staged UI hydration guardrails present');
