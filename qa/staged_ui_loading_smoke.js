...
assert(pkg.version === '1.5.28', 'staged hydration release version is v1.5.28');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.28-analysis-namespace-maintenance-history'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.28-analysis-namespace-maintenance-history'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.28 staged UI hydration guardrails present');
