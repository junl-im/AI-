...
assert(pkg.version === '1.5.29', 'staged hydration release version is v1.5.29');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.29-analysis-signature-storage-trend'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.29-analysis-signature-storage-trend'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.29 staged UI hydration guardrails present');
