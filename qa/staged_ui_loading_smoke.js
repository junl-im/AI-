...
assert(pkg.version === '1.6.12', 'staged hydration release version is v1.6.12');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.6.12-model-pack-benchmark-rollback'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.6.12-model-pack-benchmark-rollback'), 'service worker caches the staged loader');
...
console.log('PASS v1.6.12 staged UI hydration guardrails present');
