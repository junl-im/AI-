...
assert(pkg.version === '1.5.5', 'staged hydration release version is v1.5.5');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.5.5-mobile-control-ownership'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.5.5-mobile-control-ownership'), 'service worker caches the staged loader');
...
console.log('PASS v1.5.5 staged UI hydration guardrails present');
