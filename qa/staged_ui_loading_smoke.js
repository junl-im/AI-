...
assert(pkg.version === '1.2.9', 'staged hydration release version is v1.2.9');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.2.9-stability-audit'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.2.9-stability-audit'), 'service worker caches the staged loader');
...
console.log('PASS v1.2.9 staged UI hydration guardrails present');
