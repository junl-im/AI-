...
assert(pkg.version === '1.6.3', 'staged hydration release version is v1.6.3');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.6.3-stage-focus-progressive-disclosure'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.6.3-stage-focus-progressive-disclosure'), 'service worker caches the staged loader');
...
console.log('PASS v1.6.3 staged UI hydration guardrails present');
