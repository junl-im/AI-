...
assert(pkg.version === '1.6.15', 'staged hydration release version is v1.6.15');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.6.15-preview-cache-diagnostics'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.6.15-preview-cache-diagnostics'), 'service worker caches the staged loader');
...
console.log('PASS v1.6.15 staged UI hydration guardrails present');
