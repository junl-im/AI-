...
assert(pkg.version === '1.3.8', 'staged hydration release version is v1.3.8');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.3.8-adaptive-mobile'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.3.8-adaptive-mobile'), 'service worker caches the staged loader');
...
console.log('PASS v1.3.8 staged UI hydration guardrails present');
