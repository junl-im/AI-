...
assert(pkg.version === '1.6.1', 'staged hydration release version is v1.6.1');
assert(html.includes('src/boot/staged-ui-loader.js?v=1.6.1-advanced-diagnostics-gate'), 'staged UI loader is on the critical path');
...
assert(sw.includes('staged-ui-loader.js?v=1.6.1-advanced-diagnostics-gate'), 'service worker caches the staged loader');
...
console.log('PASS v1.6.1 staged UI hydration guardrails present');
