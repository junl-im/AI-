...
assert(pkg.version === '1.6.13', 'navigation focus release version is v1.6.13');
...
console.log('PASS v1.6.13 navigation focus and icon consistency guardrails present');
