...
assert(pkg.version === '1.5.28', 'navigation focus release version is v1.5.28');
...
console.log('PASS v1.5.28 navigation focus and icon consistency guardrails present');
