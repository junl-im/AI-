...
assert(pkg.version === '1.5.20', 'navigation focus release version is v1.5.20');
...
console.log('PASS v1.5.20 navigation focus and icon consistency guardrails present');
