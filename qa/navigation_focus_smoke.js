...
assert(pkg.version === '1.5.14', 'navigation focus release version is v1.5.14');
...
console.log('PASS v1.5.14 navigation focus and icon consistency guardrails present');
