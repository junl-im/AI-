...
assert(pkg.version === '1.6.12', 'navigation focus release version is v1.6.12');
...
console.log('PASS v1.6.12 navigation focus and icon consistency guardrails present');
