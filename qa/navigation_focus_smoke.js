...
assert(pkg.version === '1.6.15', 'navigation focus release version is v1.6.15');
...
console.log('PASS v1.6.15 navigation focus and icon consistency guardrails present');
