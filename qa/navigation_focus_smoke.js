...
assert(pkg.version === '1.5.16', 'navigation focus release version is v1.5.16');
...
console.log('PASS v1.5.16 navigation focus and icon consistency guardrails present');
