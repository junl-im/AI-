...
assert(pkg.version === '1.5.29', 'navigation focus release version is v1.5.29');
...
console.log('PASS v1.5.29 navigation focus and icon consistency guardrails present');
