...
assert(pkg.version === '1.5.27', 'navigation focus release version is v1.5.27');
...
console.log('PASS v1.5.27 navigation focus and icon consistency guardrails present');
