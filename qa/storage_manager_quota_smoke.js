...
const cacheNames = new Set(['ai-shorts-studio-shell-v1.5.21-old', 'ai-shorts-studio-shell-v1.6.0-local-ai-provider-foundation', 'other-cache']);
const window = {
    window: null,
    localStorage,
    ...
    AIShortsRuntimeConfig: { BUILD_KEY: '1.6.0-local-ai-provider-foundation', STORAGE_WARNING_RATIO: 0.8, STORAGE_CRITICAL_RATIO: 0.92 },
