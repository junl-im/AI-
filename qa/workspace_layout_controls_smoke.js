...
const sw = read('sw.js');
assert(pkg.version === '1.5.29', 'workspace controls release version is v1.5.29');
assert(html.includes('workspace-layout-controls.css?v=1.5.29-analysis-signature-storage-trend'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.29-analysis-signature-storage-trend'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.29-analysis-signature-storage-trend') && sw.includes('workspace-layout-controls.js?v=1.5.29-analysis-signature-storage-trend'), 'workspace control assets are cached');
console.log('PASS v1.5.29 resizable desktop workspace and focus view guardrails');
