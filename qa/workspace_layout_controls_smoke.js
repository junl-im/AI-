...
const sw = read('sw.js');
assert(pkg.version === '1.6.12', 'workspace controls release version is v1.6.12');
assert(html.includes('workspace-layout-controls.css?v=1.6.12-model-pack-benchmark-rollback'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.12-model-pack-benchmark-rollback'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.12-model-pack-benchmark-rollback') && sw.includes('workspace-layout-controls.js?v=1.6.12-model-pack-benchmark-rollback'), 'workspace control assets are cached');
console.log('PASS v1.6.12 resizable desktop workspace and focus view guardrails');
