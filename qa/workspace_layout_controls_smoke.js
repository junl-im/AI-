...
const sw = read('sw.js');
assert(pkg.version === '1.3.1', 'workspace controls release version is v1.3.1');
assert(html.includes('workspace-layout-controls.css?v=1.3.1-workspace-control'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.3.1-workspace-control'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.3.1-workspace-control') && sw.includes('workspace-layout-controls.js?v=1.3.1-workspace-control'), 'workspace control assets are cached');
console.log('PASS v1.3.1 resizable desktop workspace and focus view guardrails');
