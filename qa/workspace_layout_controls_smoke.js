...
const sw = read('sw.js');
assert(pkg.version === '1.5.7', 'workspace controls release version is v1.5.7');
assert(html.includes('workspace-layout-controls.css?v=1.5.7-responsive-density'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.7-responsive-density'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.7-responsive-density') && sw.includes('workspace-layout-controls.js?v=1.5.7-responsive-density'), 'workspace control assets are cached');
console.log('PASS v1.5.7 resizable desktop workspace and focus view guardrails');
