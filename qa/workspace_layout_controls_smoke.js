...
const sw = read('sw.js');
assert(pkg.version === '1.5.16', 'workspace controls release version is v1.5.16');
assert(html.includes('workspace-layout-controls.css?v=1.5.16-unified-import-ui'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.16-unified-import-ui'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.16-unified-import-ui') && sw.includes('workspace-layout-controls.js?v=1.5.16-unified-import-ui'), 'workspace control assets are cached');
console.log('PASS v1.5.16 resizable desktop workspace and focus view guardrails');
