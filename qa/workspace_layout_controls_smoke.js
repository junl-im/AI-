...
const sw = read('sw.js');
assert(pkg.version === '1.6.0', 'workspace controls release version is v1.6.0');
assert(html.includes('workspace-layout-controls.css?v=1.6.0-local-ai-provider-foundation'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.0-local-ai-provider-foundation'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.0-local-ai-provider-foundation') && sw.includes('workspace-layout-controls.js?v=1.6.0-local-ai-provider-foundation'), 'workspace control assets are cached');
console.log('PASS v1.6.0 resizable desktop workspace and focus view guardrails');
