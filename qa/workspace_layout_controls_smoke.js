...
const sw = read('sw.js');
assert(pkg.version === '1.5.28', 'workspace controls release version is v1.5.28');
assert(html.includes('workspace-layout-controls.css?v=1.5.28-analysis-namespace-maintenance-history'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.28-analysis-namespace-maintenance-history'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.28-analysis-namespace-maintenance-history') && sw.includes('workspace-layout-controls.js?v=1.5.28-analysis-namespace-maintenance-history'), 'workspace control assets are cached');
console.log('PASS v1.5.28 resizable desktop workspace and focus view guardrails');
