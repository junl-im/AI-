...
const sw = read('sw.js');
assert(pkg.version === '1.6.9', 'workspace controls release version is v1.6.9');
assert(html.includes('workspace-layout-controls.css?v=1.6.9-direct-crop-editor'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.9-direct-crop-editor'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.9-direct-crop-editor') && sw.includes('workspace-layout-controls.js?v=1.6.9-direct-crop-editor'), 'workspace control assets are cached');
console.log('PASS v1.6.9 resizable desktop workspace and focus view guardrails');
