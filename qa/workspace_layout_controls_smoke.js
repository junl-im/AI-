...
const sw = read('sw.js');
assert(pkg.version === '1.5.6', 'workspace controls release version is v1.5.6');
assert(html.includes('workspace-layout-controls.css?v=1.5.6-ui-clarity'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.6-ui-clarity'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.6-ui-clarity') && sw.includes('workspace-layout-controls.js?v=1.5.6-ui-clarity'), 'workspace control assets are cached');
console.log('PASS v1.5.6 resizable desktop workspace and focus view guardrails');
