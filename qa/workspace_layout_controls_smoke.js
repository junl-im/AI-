...
const sw = read('sw.js');
assert(pkg.version === '1.4.1', 'workspace controls release version is v1.4.1');
assert(html.includes('workspace-layout-controls.css?v=1.4.1-adaptive-mobile'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.4.1-adaptive-mobile'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.4.1-adaptive-mobile') && sw.includes('workspace-layout-controls.js?v=1.4.1-adaptive-mobile'), 'workspace control assets are cached');
console.log('PASS v1.4.1 resizable desktop workspace and focus view guardrails');
