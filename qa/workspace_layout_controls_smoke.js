...
const sw = read('sw.js');
assert(pkg.version === '1.5.17', 'workspace controls release version is v1.5.17');
assert(html.includes('workspace-layout-controls.css?v=1.5.17-important-cascade-reduction'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.17-important-cascade-reduction'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.17-important-cascade-reduction') && sw.includes('workspace-layout-controls.js?v=1.5.17-important-cascade-reduction'), 'workspace control assets are cached');
console.log('PASS v1.5.17 resizable desktop workspace and focus view guardrails');
