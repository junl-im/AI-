...
const sw = read('sw.js');
assert(pkg.version === '1.3.2', 'workspace controls release version is v1.3.2');
assert(html.includes('workspace-layout-controls.css?v=1.3.2-media-e2e'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.3.2-media-e2e'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.3.2-media-e2e') && sw.includes('workspace-layout-controls.js?v=1.3.2-media-e2e'), 'workspace control assets are cached');
console.log('PASS v1.3.2 resizable desktop workspace and focus view guardrails');
