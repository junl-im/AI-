...
const sw = read('sw.js');
assert(pkg.version === '1.5.26', 'workspace controls release version is v1.5.26');
assert(html.includes('workspace-layout-controls.css?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.26-adaptive-cache-audit-protected-recovery') && sw.includes('workspace-layout-controls.js?v=1.5.26-adaptive-cache-audit-protected-recovery'), 'workspace control assets are cached');
console.log('PASS v1.5.26 resizable desktop workspace and focus view guardrails');
