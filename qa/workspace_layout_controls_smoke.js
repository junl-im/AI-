...
const sw = read('sw.js');
assert(pkg.version === '1.6.4', 'workspace controls release version is v1.6.4');
assert(html.includes('workspace-layout-controls.css?v=1.6.4-recovery-loop-impact-preview'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.4-recovery-loop-impact-preview'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.4-recovery-loop-impact-preview') && sw.includes('workspace-layout-controls.js?v=1.6.4-recovery-loop-impact-preview'), 'workspace control assets are cached');
console.log('PASS v1.6.4 resizable desktop workspace and focus view guardrails');
