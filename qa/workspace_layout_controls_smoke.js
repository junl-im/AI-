...
const sw = read('sw.js');
assert(pkg.version === '1.5.20', 'workspace controls release version is v1.5.20');
assert(html.includes('workspace-layout-controls.css?v=1.5.20-structure-responsive-priority'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.20-structure-responsive-priority'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.20-structure-responsive-priority') && sw.includes('workspace-layout-controls.js?v=1.5.20-structure-responsive-priority'), 'workspace control assets are cached');
console.log('PASS v1.5.20 resizable desktop workspace and focus view guardrails');
