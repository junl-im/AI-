...
const sw = read('sw.js');
assert(pkg.version === '1.5.25', 'workspace controls release version is v1.5.25');
assert(html.includes('workspace-layout-controls.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit') && sw.includes('workspace-layout-controls.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'workspace control assets are cached');
console.log('PASS v1.5.25 resizable desktop workspace and focus view guardrails');
