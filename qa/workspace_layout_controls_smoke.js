...
const sw = read('sw.js');
assert(pkg.version === '1.6.2', 'workspace controls release version is v1.6.2');
assert(html.includes('workspace-layout-controls.css?v=1.6.2-layout-harmony-footer-health'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.2-layout-harmony-footer-health'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.2-layout-harmony-footer-health') && sw.includes('workspace-layout-controls.js?v=1.6.2-layout-harmony-footer-health'), 'workspace control assets are cached');
console.log('PASS v1.6.2 resizable desktop workspace and focus view guardrails');
