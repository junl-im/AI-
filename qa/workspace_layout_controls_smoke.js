...
const sw = read('sw.js');
assert(pkg.version === '1.6.13', 'workspace controls release version is v1.6.13');
assert(html.includes('workspace-layout-controls.css?v=1.6.13-transactional-model-pack-qa-controls'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.13-transactional-model-pack-qa-controls'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.13-transactional-model-pack-qa-controls') && sw.includes('workspace-layout-controls.js?v=1.6.13-transactional-model-pack-qa-controls'), 'workspace control assets are cached');
console.log('PASS v1.6.13 resizable desktop workspace and focus view guardrails');
