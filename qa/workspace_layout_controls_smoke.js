...
const sw = read('sw.js');
assert(pkg.version === '1.5.14', 'workspace controls release version is v1.5.14');
assert(html.includes('workspace-layout-controls.css?v=1.5.14-cascade-dedup'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.14-cascade-dedup'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.14-cascade-dedup') && sw.includes('workspace-layout-controls.js?v=1.5.14-cascade-dedup'), 'workspace control assets are cached');
console.log('PASS v1.5.14 resizable desktop workspace and focus view guardrails');
