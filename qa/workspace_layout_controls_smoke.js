...
const sw = read('sw.js');
assert(pkg.version === '1.3.5', 'workspace controls release version is v1.3.5');
assert(html.includes('workspace-layout-controls.css?v=1.3.5-adaptive-mobile'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.3.5-adaptive-mobile'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.3.5-adaptive-mobile') && sw.includes('workspace-layout-controls.js?v=1.3.5-adaptive-mobile'), 'workspace control assets are cached');
console.log('PASS v1.3.5 resizable desktop workspace and focus view guardrails');
