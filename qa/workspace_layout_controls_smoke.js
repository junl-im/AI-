...
const sw = read('sw.js');
assert(pkg.version === '1.5.5', 'workspace controls release version is v1.5.5');
assert(html.includes('workspace-layout-controls.css?v=1.5.5-mobile-control-ownership'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.5-mobile-control-ownership'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.5-mobile-control-ownership') && sw.includes('workspace-layout-controls.js?v=1.5.5-mobile-control-ownership'), 'workspace control assets are cached');
console.log('PASS v1.5.5 resizable desktop workspace and focus view guardrails');
