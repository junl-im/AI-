...
const sw = read('sw.js');
assert(pkg.version === '1.5.24', 'workspace controls release version is v1.5.24');
assert(html.includes('workspace-layout-controls.css?v=1.5.24-compressed-session-integrity-rollback'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.24-compressed-session-integrity-rollback'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.24-compressed-session-integrity-rollback') && sw.includes('workspace-layout-controls.js?v=1.5.24-compressed-session-integrity-rollback'), 'workspace control assets are cached');
console.log('PASS v1.5.24 resizable desktop workspace and focus view guardrails');
