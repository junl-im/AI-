...
const sw = read('sw.js');
assert(pkg.version === '1.6.1', 'workspace controls release version is v1.6.1');
assert(html.includes('workspace-layout-controls.css?v=1.6.1-advanced-diagnostics-gate'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.1-advanced-diagnostics-gate'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.1-advanced-diagnostics-gate') && sw.includes('workspace-layout-controls.js?v=1.6.1-advanced-diagnostics-gate'), 'workspace control assets are cached');
console.log('PASS v1.6.1 resizable desktop workspace and focus view guardrails');
