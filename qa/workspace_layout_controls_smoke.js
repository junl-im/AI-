...
const sw = read('sw.js');
assert(pkg.version === '1.5.27', 'workspace controls release version is v1.5.27');
assert(html.includes('workspace-layout-controls.css?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.27-selective-cache-integrity-retry-portable-backup') && sw.includes('workspace-layout-controls.js?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'workspace control assets are cached');
console.log('PASS v1.5.27 resizable desktop workspace and focus view guardrails');
