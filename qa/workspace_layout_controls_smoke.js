...
const sw = read('sw.js');
assert(pkg.version === '1.6.5', 'workspace controls release version is v1.6.5');
assert(html.includes('workspace-layout-controls.css?v=1.6.5-smart-reframe-caption-safe'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.5-smart-reframe-caption-safe'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.5-smart-reframe-caption-safe') && sw.includes('workspace-layout-controls.js?v=1.6.5-smart-reframe-caption-safe'), 'workspace control assets are cached');
console.log('PASS v1.6.5 resizable desktop workspace and focus view guardrails');
