...
const sw = read('sw.js');
assert(pkg.version === '1.6.3', 'workspace controls release version is v1.6.3');
assert(html.includes('workspace-layout-controls.css?v=1.6.3-stage-focus-progressive-disclosure'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.6.3-stage-focus-progressive-disclosure'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.6.3-stage-focus-progressive-disclosure') && sw.includes('workspace-layout-controls.js?v=1.6.3-stage-focus-progressive-disclosure'), 'workspace control assets are cached');
console.log('PASS v1.6.3 resizable desktop workspace and focus view guardrails');
