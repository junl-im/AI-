...
const sw = read('sw.js');
assert(pkg.version === '1.5.3', 'workspace controls release version is v1.5.3');
assert(html.includes('workspace-layout-controls.css?v=1.5.3-media-engine'), 'workspace layout stylesheet is linked');
...
assert(html.includes('workspace-layout-controls.js?v=1.5.3-media-engine'), 'workspace controller is loaded');
...
assert(sw.includes('workspace-layout-controls.css?v=1.5.3-media-engine') && sw.includes('workspace-layout-controls.js?v=1.5.3-media-engine'), 'workspace control assets are cached');
console.log('PASS v1.5.3 resizable desktop workspace and focus view guardrails');
