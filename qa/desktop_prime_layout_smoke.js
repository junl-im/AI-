...
assert(pkg.version === '1.6.12', 'desktop prime release version is v1.6.12');
...
console.log('PASS v1.6.12 desktop utility hub, single import flow, and prime layout guardrails');
