...
assert(pkg.version === '1.5.24', 'desktop prime release version is v1.5.24');
...
console.log('PASS v1.5.24 desktop utility hub, single import flow, and prime layout guardrails');
