...
assert(/^1\.6\.\d+$/.test(pkg.version), 'desktop prime release version is v1.6.25');
...
console.log('PASS v1.6.25 desktop utility hub, single import flow, and prime layout guardrails');
