...
assert(pkg.version === '1.2.2', 'desktop prime release version is v1.2.2');
assert(html.includes('assets/css/desktop-prime-layout.css?v=1.2.2-desktop-prime'), 'desktop prime stylesheet is linked last');
assert(sw.includes('desktop-prime-layout.css?v=1.2.2-desktop-prime'), 'desktop prime stylesheet is cached');
...
console.log('PASS v1.2.2 desktop prime and mobile flow-only guardrails present');
