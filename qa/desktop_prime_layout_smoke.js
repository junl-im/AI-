...
assert(pkg.version === '1.6.3', 'desktop prime release version is v1.6.3');
...
console.log('PASS v1.6.3 desktop utility hub, single import flow, and prime layout guardrails');
