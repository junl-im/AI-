...
assert(pkg.version === '1.3.5', 'desktop prime release version is v1.3.5');
assert(html.includes('assets/css/desktop-prime-layout.css?v=1.3.5-adaptive-mobile'), 'desktop prime stylesheet is linked last');
assert(sw.includes('desktop-prime-layout.css?v=1.3.5-adaptive-mobile'), 'desktop prime stylesheet is cached');
...
console.log('PASS v1.3.5 desktop prime and mobile flow-only guardrails present');
