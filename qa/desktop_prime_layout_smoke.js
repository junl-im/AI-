...
assert(pkg.version === '1.5.29', 'desktop prime release version is v1.5.29');
...
console.log('PASS v1.5.29 desktop utility hub, single import flow, and prime layout guardrails');
