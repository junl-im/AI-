...
assert(pkg.version === '1.6.13', 'desktop prime release version is v1.6.13');
...
console.log('PASS v1.6.13 desktop utility hub, single import flow, and prime layout guardrails');
