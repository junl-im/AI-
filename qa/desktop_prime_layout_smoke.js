...
assert(pkg.version === '1.4.1', 'desktop prime release version is v1.4.1');
assert(html.includes('assets/css/desktop-prime-layout.css?v=1.4.1-adaptive-mobile'), 'desktop prime stylesheet is linked last');
assert(sw.includes('desktop-prime-layout.css?v=1.4.1-adaptive-mobile'), 'desktop prime stylesheet is cached');
...
console.log('PASS v1.4.1 desktop prime and mobile flow-only guardrails present');
