...
assert(pkg.version === '1.6.0', 'desktop prime release version is v1.6.0');
...
console.log('PASS v1.6.0 desktop utility hub, single import flow, and prime layout guardrails');
