...
assert(pkg.version === '1.6.2', 'desktop prime release version is v1.6.2');
...
console.log('PASS v1.6.2 desktop utility hub, single import flow, and prime layout guardrails');
