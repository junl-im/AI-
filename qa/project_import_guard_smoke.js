...
assert(service && service.CURRENT_SCHEMA_VERSION === 5, 'project schema guard is exposed at version 5');
...
assert(mediaImport.includes('state.mediaSessionId !== mediaSessionId || state.file !== file') && mediaImport.includes('sequence !== importSequence'), 'stale delayed auto-analysis is discarded');
...
console.log('PASS v1.6.20 project import, session restore, and file-size exception guardrails');
