...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.20-structure-responsive-priority');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.20-structure-responsive-priority');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.20-structure-responsive-priority');
