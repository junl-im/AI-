...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
