...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.5-smart-reframe-caption-safe');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.5-smart-reframe-caption-safe');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.5-smart-reframe-caption-safe');
