...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.2.8-header-meta');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.2.8-header-meta');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.2.8-header-meta');
