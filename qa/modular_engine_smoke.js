...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.2-experience-engine');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.2-experience-engine');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.2-experience-engine');
