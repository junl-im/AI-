...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.1-advanced-diagnostics-gate');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.1-advanced-diagnostics-gate');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.1-advanced-diagnostics-gate');
