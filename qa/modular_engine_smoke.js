...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.0.1-responsive-layout');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.0.1-responsive-layout');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.0.1-responsive-layout');
