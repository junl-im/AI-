...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.3-stage-focus-progressive-disclosure');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.3-stage-focus-progressive-disclosure');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.3-stage-focus-progressive-disclosure');
