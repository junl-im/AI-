...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.5-mobile-control-ownership');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.5-mobile-control-ownership');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.5-mobile-control-ownership');
