...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.2-layout-harmony-footer-health');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.2-layout-harmony-footer-health');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.2-layout-harmony-footer-health');
