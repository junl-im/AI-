...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.3.2-media-e2e');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.3.2-media-e2e');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.3.2-media-e2e');
