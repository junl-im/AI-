...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.24-compressed-session-integrity-rollback');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.24-compressed-session-integrity-rollback');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.24-compressed-session-integrity-rollback');
