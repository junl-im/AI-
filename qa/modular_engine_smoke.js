...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.4-recovery-loop-impact-preview');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.4-recovery-loop-impact-preview');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.4-recovery-loop-impact-preview');
