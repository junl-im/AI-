...
assertIncludes('index.html', 'src/engine/module-registry.js?v=0.9.7-flow-hotfix');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=0.9.7-flow-hotfix');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=0.9.7-flow-hotfix');
