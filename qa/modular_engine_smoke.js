...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.3.1-workspace-control');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.3.1-workspace-control');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.3.1-workspace-control');
