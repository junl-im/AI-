...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.13-transactional-model-pack-qa-controls');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.13-transactional-model-pack-qa-controls');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.13-transactional-model-pack-qa-controls');
