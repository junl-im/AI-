...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.17-important-cascade-reduction');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.17-important-cascade-reduction');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.17-important-cascade-reduction');
