...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.0.0-cinematic-hero');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.0.0-cinematic-hero');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.0.0-cinematic-hero');
