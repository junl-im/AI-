...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.12-model-pack-benchmark-rollback');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.12-model-pack-benchmark-rollback');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.12-model-pack-benchmark-rollback');
