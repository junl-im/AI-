...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.4-css-ownership');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.4-css-ownership');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.4-css-ownership');
