...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.0-local-ai-provider-foundation');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.0-local-ai-provider-foundation');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.0-local-ai-provider-foundation');
