...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.6.9-direct-crop-editor');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.6.9-direct-crop-editor');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.6.9-direct-crop-editor');
