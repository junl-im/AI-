...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.2.6-flow-audit');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.2.6-flow-audit');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.2.6-flow-audit');
