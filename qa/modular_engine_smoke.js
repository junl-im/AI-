...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.3.8-adaptive-mobile');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.3.8-adaptive-mobile');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.3.8-adaptive-mobile');
