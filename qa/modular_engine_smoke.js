...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.14-cascade-dedup');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.14-cascade-dedup');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.14-cascade-dedup');
