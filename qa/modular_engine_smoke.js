...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.26-adaptive-cache-audit-protected-recovery');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.26-adaptive-cache-audit-protected-recovery');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.26-adaptive-cache-audit-protected-recovery');
