...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.7-responsive-density');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.7-responsive-density');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.7-responsive-density');
