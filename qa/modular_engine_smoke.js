...
assertIncludes('index.html', 'src/engine/module-registry.js?v=1.5.28-analysis-namespace-maintenance-history');
assertIncludes('index.html', 'src/engine/engine-kernel.js?v=1.5.28-analysis-namespace-maintenance-history');
...
assertIncludes('sw.js', 'src/engine/scoring-pipeline.js?v=1.5.28-analysis-namespace-maintenance-history');
