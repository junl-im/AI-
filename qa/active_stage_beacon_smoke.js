...
assert(html.includes('assets/css/active-stage-beacon.css?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit'), 'active stage beacon stylesheet is loaded');
