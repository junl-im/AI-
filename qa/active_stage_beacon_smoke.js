...
assert(html.includes('assets/css/active-stage-beacon.css?v=1.5.27-selective-cache-integrity-retry-portable-backup'), 'active stage beacon stylesheet is loaded');
