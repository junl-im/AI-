...
ok(html.includes(`assets/css/update-sentinel.css?v=${version}-ui-clarity`), 'update sentinel css linked');
ok(html.includes(`src/boot/update-sentinel.js?v=${version}-ui-clarity`), 'update sentinel script linked');
ok(sw.includes(`./assets/css/update-sentinel.css?v=${version}-ui-clarity`), 'update sentinel css cached');
ok(sw.includes(`./src/boot/update-sentinel.js?v=${version}-ui-clarity`), 'update sentinel script cached');
