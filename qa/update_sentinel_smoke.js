...
ok(html.includes(`assets/css/update-sentinel.css?v=${version}-adaptive-mobile`), 'update sentinel css linked');
ok(html.includes(`src/boot/update-sentinel.js?v=${version}-adaptive-mobile`), 'update sentinel script linked');
ok(sw.includes(`./assets/css/update-sentinel.css?v=${version}-adaptive-mobile`), 'update sentinel css cached');
ok(sw.includes(`./src/boot/update-sentinel.js?v=${version}-adaptive-mobile`), 'update sentinel script cached');
