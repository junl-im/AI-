...
ok(pkg.version === '1.6.3', 'package version is v1.6.3');
ok(html.includes('assets/css/save-readiness.css?v=1.6.3-stage-focus-progressive-disclosure'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.6.3-stage-focus-progressive-disclosure'), 'service worker caches save readiness css');
