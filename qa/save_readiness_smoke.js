...
ok(pkg.version === '1.6.13', 'package version is v1.6.13');
ok(html.includes('assets/css/save-readiness.css?v=1.6.13-transactional-model-pack-qa-controls'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.6.13-transactional-model-pack-qa-controls'), 'service worker caches save readiness css');
