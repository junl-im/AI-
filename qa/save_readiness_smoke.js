...
ok(pkg.version === '1.1.4', 'package version is v1.1.4');
ok(html.includes('assets/css/save-readiness.css?v=1.1.4-save-readiness'), 'save readiness stylesheet linked');
ok(html.includes('src/ui/save-readiness.js?v=1.1.4-save-readiness'), 'save readiness script linked');
ok(sw.includes('./assets/css/save-readiness.css?v=1.1.4-save-readiness'), 'service worker caches save readiness css');
ok(sw.includes('./src/ui/save-readiness.js?v=1.1.4-save-readiness'), 'service worker caches save readiness js');
