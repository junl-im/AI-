...
ok(pkg.version === '1.5.29', 'package version is v1.5.29');
ok(html.includes('assets/css/save-readiness.css?v=1.5.29-analysis-signature-storage-trend'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.5.29-analysis-signature-storage-trend'), 'service worker caches save readiness css');
