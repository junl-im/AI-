...
ok(html.includes('assets/css/save-readiness.css?v=1.6.5-smart-reframe-caption-safe'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.6.5-smart-reframe-caption-safe'), 'service worker caches save readiness css');
