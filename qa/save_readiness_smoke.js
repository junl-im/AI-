...
ok(html.includes('assets/css/save-readiness.css?v=1.2.8-header-meta'), 'save readiness stylesheet linked');
ok(loader.includes('src/ui/save-readiness.js?v=${VERSION}-save-readiness'), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.2.8-header-meta'), 'service worker caches save readiness css');
