...
ok(pkg.version === '1.6.0', 'package version is v1.6.0');
ok(html.includes('assets/css/save-readiness.css?v=1.6.0-local-ai-provider-foundation'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.6.0-local-ai-provider-foundation'), 'service worker caches save readiness css');
