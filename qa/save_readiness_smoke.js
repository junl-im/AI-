...
ok(pkg.version === '1.6.2', 'package version is v1.6.2');
ok(html.includes('assets/css/save-readiness.css?v=1.6.2-layout-harmony-footer-health'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.6.2-layout-harmony-footer-health'), 'service worker caches save readiness css');
