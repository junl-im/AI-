...
ok(html.includes('assets/css/save-readiness.css?v=1.5.4-css-ownership'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.5.4-css-ownership'), 'service worker caches save readiness css');
