...
ok(pkg.version === '1.2.9', 'package version is v1.2.9');
ok(html.includes('assets/css/save-readiness.css?v=1.2.9-stability-audit'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.2.9-stability-audit'), 'service worker caches save readiness css');
