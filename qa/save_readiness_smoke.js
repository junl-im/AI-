...
ok(pkg.version === '1.4.1', 'package version is v1.4.1');
ok(html.includes('assets/css/save-readiness.css?v=1.4.1-adaptive-mobile'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.4.1-adaptive-mobile'), 'service worker caches save readiness css');
