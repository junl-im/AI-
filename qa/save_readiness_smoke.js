...
ok(pkg.version === '1.3.2', 'package version is v1.3.2');
ok(html.includes('assets/css/save-readiness.css?v=1.3.2-media-e2e'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.3.2-media-e2e'), 'service worker caches save readiness css');
