...
ok(pkg.version === '1.3.1', 'package version is v1.3.1');
ok(html.includes('assets/css/save-readiness.css?v=1.3.1-workspace-control'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.3.1-workspace-control'), 'service worker caches save readiness css');
