...
ok(pkg.version === '1.5.3', 'package version is v1.5.3');
ok(html.includes('assets/css/save-readiness.css?v=1.5.3-media-engine'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.5.3-media-engine'), 'service worker caches save readiness css');
