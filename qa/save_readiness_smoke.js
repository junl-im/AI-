...
ok(pkg.version === '1.6.4', 'package version is v1.6.4');
ok(html.includes('assets/css/save-readiness.css?v=1.6.4-recovery-loop-impact-preview'), 'save readiness stylesheet linked');
ok(loader.includes("versioned('src/ui/save-readiness.js', 'editing')"), 'save readiness script staged');
ok(sw.includes('./assets/css/save-readiness.css?v=1.6.4-recovery-loop-impact-preview'), 'service worker caches save readiness css');
