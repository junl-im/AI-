...
assert(html.includes('brand-compat-pill') && html.includes('LOCAL · PRIVATE · READY'), 'topline includes local/private readiness');
...
assert(finalJs.includes("document.body.dataset.build = '1.2.2'"), 'final director build is v1.2.2');
