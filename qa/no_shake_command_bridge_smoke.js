...
assert(finalJs.includes('const BUILD_VERSION') && finalJs.includes('document.body.dataset.build = BUILD_VERSION'), 'final director build marker follows runtime config');
