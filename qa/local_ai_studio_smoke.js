...
assert(css.includes('.local-ai-grid') && css.includes('@media (max-width: 620px)') && !css.includes('!important'), 'local AI panel has responsive ownership without new priority overrides');
