...
ok(pkg.version === '1.5.16', 'package version is 1.2.9');
ok(html.includes('assets/css/candidate-pin-board.css?v=1.5.16-unified-import-ui'), 'candidate pin stylesheet linked');
ok(loader.includes("versioned('src/ui/candidate-pin-board.js', 'editing')"), 'candidate pin script staged');
ok(sw.includes('./assets/css/candidate-pin-board.css?v=1.5.16-unified-import-ui'), 'candidate pin css cached');
