...
ok(pkg.version === '1.2.0', 'package version is 1.2.0');
ok(html.includes('assets/css/candidate-pin-board.css?v=1.2.0-candidate-pin'), 'candidate pin stylesheet linked');
ok(html.includes('src/ui/candidate-pin-board.js?v=1.2.0-candidate-pin'), 'candidate pin script linked');
ok(sw.includes('./assets/css/candidate-pin-board.css?v=1.2.0-candidate-pin'), 'candidate pin css cached');
ok(sw.includes('./src/ui/candidate-pin-board.js?v=1.2.0-candidate-pin'), 'candidate pin script cached');
