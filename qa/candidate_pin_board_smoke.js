...
ok(pkg.version === '1.2.8', 'package version is 1.2.8');
ok(html.includes('assets/css/candidate-pin-board.css?v=1.2.8-header-meta'), 'candidate pin stylesheet linked');
ok(loader.includes('src/ui/candidate-pin-board.js?v=${VERSION}-candidate-pin'), 'candidate pin script staged');
ok(sw.includes('./assets/css/candidate-pin-board.css?v=1.2.8-header-meta'), 'candidate pin css cached');
