...
ok(pkg.version === '1.2.6', 'package version is 1.2.6');
ok(html.includes('assets/css/candidate-pin-board.css?v=1.2.6-candidate-pin'), 'candidate pin stylesheet linked');
ok(loader.includes('src/ui/candidate-pin-board.js?v=${VERSION}-candidate-pin'), 'candidate pin script staged');
ok(sw.includes('./assets/css/candidate-pin-board.css?v=1.2.6-candidate-pin'), 'candidate pin css cached');
