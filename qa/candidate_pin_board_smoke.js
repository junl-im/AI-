...
ok(pkg.version === '1.3.2', 'package version is 1.2.9');
ok(html.includes('assets/css/candidate-pin-board.css?v=1.3.2-media-e2e'), 'candidate pin stylesheet linked');
ok(loader.includes("versioned('src/ui/candidate-pin-board.js', 'editing')"), 'candidate pin script staged');
ok(sw.includes('./assets/css/candidate-pin-board.css?v=1.3.2-media-e2e'), 'candidate pin css cached');
