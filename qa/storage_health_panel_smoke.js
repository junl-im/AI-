...
ok(html.includes('assets/css/storage-health-panel.css?v=1.6.4-recovery-loop-impact-preview'), 'storage health stylesheet is linked');
ok(html.includes('src/storage/storage-manager.js?v=1.6.4-recovery-loop-impact-preview'), 'quota-aware storage manager is on the core path');
ok(loader.includes("versioned('src/ui/storage-health-panel.js', 'shell')"), 'storage health UI is loaded with the shell phase');
ok(sw.includes('storage-health-panel.css?v=1.6.4-recovery-loop-impact-preview') && sw.includes('storage-manager.js?v=1.6.4-recovery-loop-impact-preview'), 'storage diagnostics assets are available offline');
