...
ok(html.includes('assets/css/storage-health-panel.css?v=1.6.13-transactional-model-pack-qa-controls'), 'storage health stylesheet is linked');
ok(html.includes('src/storage/storage-manager.js?v=1.6.13-transactional-model-pack-qa-controls'), 'quota-aware storage manager is on the core path');
ok(loader.includes("versioned('src/ui/storage-health-panel.js', 'shell')"), 'storage health UI is loaded with the shell phase');
ok(sw.includes('storage-health-panel.css?v=1.6.13-transactional-model-pack-qa-controls') && sw.includes('storage-manager.js?v=1.6.13-transactional-model-pack-qa-controls'), 'storage diagnostics assets are available offline');
