...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.6.5-smart-reframe-caption-safe');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.6.5-smart-reframe-caption-safe');
