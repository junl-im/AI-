...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.5.5-mobile-control-ownership');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.5.5-mobile-control-ownership');
