...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.6.12-model-pack-benchmark-rollback');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.6.12-model-pack-benchmark-rollback');
