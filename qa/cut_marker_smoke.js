...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.5.7-responsive-density');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.5.7-responsive-density');
