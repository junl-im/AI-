...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.5.27-selective-cache-integrity-retry-portable-backup');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.5.27-selective-cache-integrity-retry-portable-backup');
