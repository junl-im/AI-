...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.5.24-compressed-session-integrity-rollback');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.5.24-compressed-session-integrity-rollback');
