...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.6.4-recovery-loop-impact-preview');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.6.4-recovery-loop-impact-preview');
