...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.5.25-persistent-analysis-selective-recovery-integrity-audit');
