...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.6.9-direct-crop-editor');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.6.9-direct-crop-editor');
