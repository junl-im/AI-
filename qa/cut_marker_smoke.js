...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.6.0-local-ai-provider-foundation');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.6.0-local-ai-provider-foundation');
