...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.6.1-advanced-diagnostics-gate');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.6.1-advanced-diagnostics-gate');
