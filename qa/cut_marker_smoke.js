...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.5.16-unified-import-ui');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.5.16-unified-import-ui');
