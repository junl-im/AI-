...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.5.28-analysis-namespace-maintenance-history');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.5.28-analysis-namespace-maintenance-history');
