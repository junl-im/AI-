...
assertIncludes('index.html', 'src/ui/cut-marker-overlay.js?v=1.6.13-transactional-model-pack-qa-controls');
...
assertIncludes('sw.js', 'cut-marker-overlay.js?v=1.6.13-transactional-model-pack-qa-controls');
