...
ok(pkg.version === '1.6.12', 'important cascade reduction release version is v1.6.12');
...
console.log('PASS v1.6.12 safe important reduction with unchanged responsive layout metrics');
