...
ok(pkg.version === '1.5.24', 'important cascade reduction release version is v1.5.24');
...
console.log('PASS v1.5.24 safe important reduction with unchanged responsive layout metrics');
