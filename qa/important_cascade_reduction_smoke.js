...
ok(pkg.version === '1.6.5', 'important cascade reduction release version is v1.6.5');
...
console.log('PASS v1.6.5 safe important reduction with unchanged responsive layout metrics');
