...
ok(pkg.version === '1.6.4', 'important cascade reduction release version is v1.6.4');
...
console.log('PASS v1.6.4 safe important reduction with unchanged responsive layout metrics');
