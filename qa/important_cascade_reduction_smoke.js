...
ok(pkg.version === '1.5.29', 'important cascade reduction release version is v1.5.29');
...
console.log('PASS v1.5.29 safe important reduction with unchanged responsive layout metrics');
