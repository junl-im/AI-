...
ok(pkg.version === '1.6.13', 'important cascade reduction release version is v1.6.13');
...
console.log('PASS v1.6.13 safe important reduction with unchanged responsive layout metrics');
