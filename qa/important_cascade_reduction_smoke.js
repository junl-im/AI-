...
ok(pkg.version === '1.6.9', 'important cascade reduction release version is v1.6.9');
...
console.log('PASS v1.6.9 safe important reduction with unchanged responsive layout metrics');
