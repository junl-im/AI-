...
ok(pkg.version === '1.5.28', 'important cascade reduction release version is v1.5.28');
...
console.log('PASS v1.5.28 safe important reduction with unchanged responsive layout metrics');
