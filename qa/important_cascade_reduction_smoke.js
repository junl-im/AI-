...
ok(pkg.version === '1.6.15', 'important cascade reduction release version is v1.6.15');
...
console.log('PASS v1.6.15 safe important reduction with unchanged responsive layout metrics');
