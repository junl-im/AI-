...
ok(pkg.version === '1.6.0', 'important cascade reduction release version is v1.6.0');
...
console.log('PASS v1.6.0 safe important reduction with unchanged responsive layout metrics');
