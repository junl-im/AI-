...
ok(pkg.version === '1.5.25', 'important cascade reduction release version is v1.5.25');
...
console.log('PASS v1.5.25 safe important reduction with unchanged responsive layout metrics');
