...
ok(pkg.version === '1.5.27', 'important cascade reduction release version is v1.5.27');
...
console.log('PASS v1.5.27 safe important reduction with unchanged responsive layout metrics');
