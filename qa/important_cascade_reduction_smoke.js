...
ok(pkg.version === '1.6.1', 'important cascade reduction release version is v1.6.1');
...
console.log('PASS v1.6.1 safe important reduction with unchanged responsive layout metrics');
