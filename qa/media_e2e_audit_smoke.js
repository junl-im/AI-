...
const auditPath = path.join(root, 'qa', 'runtime-media-e2e-v1.3.7.json');
...
assert(report.version === '1.3.7', 'real-media E2E audit matches v1.3.7');
...
console.log('PASS v1.3.7 MP3, MP4, cancel, retry, long-media, and ETA browser E2E audit');
