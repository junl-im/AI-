...
const auditPath = path.join(root, 'qa', 'runtime-media-e2e-v1.5.3.json');
...
console.log('PASS v1.5.16 inherits the unchanged v1.5.3 MP3, MP4, cancel, retry, long-media, and ETA audit');
