...
const auditPath = path.join(root, 'qa', 'runtime-media-e2e-v1.4.1.json');
...
assert(report.version === '1.4.1', 'real-media E2E audit matches v1.4.1');
...
console.log('PASS v1.4.1 MP3, MP4, cancel, retry, long-media, and ETA browser E2E audit');
