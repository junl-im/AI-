...
const auditPath = path.join(root, 'qa', 'runtime-media-e2e-v1.3.4.json');
...
assert(report.version === '1.3.4', 'real-media E2E audit matches v1.3.4');
...
console.log('PASS v1.3.4 MP3, MP4, cancel, retry, long-media, and ETA browser E2E audit');
