...
const auditPath = path.join(root, 'qa', 'runtime-media-e2e-v1.5.2.json');
...
assert(report.version === '1.5.2', 'real-media E2E audit matches v1.5.2');
...
console.log('PASS v1.5.2 MP3, MP4, cancel, retry, long-media, and ETA browser E2E audit');
