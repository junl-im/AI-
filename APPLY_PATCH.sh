...
set -eu
cd "$(dirname "$0")"
node scripts/apply-delete-list.mjs docs/patches/0.9.3-beta.3-engine-heartbeat-4/DELETE_LIST.txt
...
printf '%s\n' 'Engine Heartbeat 4 패치 적용 완료. GitHub Desktop에서 변경과 삭제를 Commit/Push하세요.'
