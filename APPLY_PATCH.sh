...
set -eu
cd "$(dirname "$0")"
node scripts/apply-delete-list.mjs docs/patches/0.9.3-beta.3-engine-heartbeat-5.1-web-quality-hotfix/DELETE_LIST.txt
...
printf '%s\n' 'Engine Heartbeat 5.1 Web Quality Hotfix 적용 완료. GitHub Desktop에서 변경을 Commit/Push하세요.'
