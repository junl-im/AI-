...
set -eu
cd "$(dirname "$0")"
node scripts/apply-delete-list.mjs docs/patches/0.11.11-mobile-studio-flow-natural-voice-playback/DELETE_LIST.txt
printf '%s\n' 'SoriON AI v0.11.11 Mobile Studio Flow & Natural Voice Playback가 적용되었습니다.'
printf '%s\n' '모바일 Dock/Player, voice chooser, composer navigation, horizontal timeline, playback link 계약을 확인합니다.'
