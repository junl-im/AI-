...
setlocal
cd /d "%~dp0"
node scripts\apply-delete-list.mjs docs\patches\0.9.3-beta.3-engine-heartbeat-6.4-signed-audio-device-certification\DELETE_LIST.txt || exit /b 1
...
echo Engine Heartbeat 6.4 Signed Audio Rehydration ^& Device Certification 적용 완료. GitHub Desktop에서 변경을 Commit/Push하세요.
git status --short
endlocal
