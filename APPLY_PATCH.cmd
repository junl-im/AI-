...
setlocal
cd /d "%~dp0"
node scripts\apply-delete-list.mjs docs\patches\0.9.3-beta.3-engine-heartbeat-5\DELETE_LIST.txt || exit /b 1
...
echo Engine Heartbeat 5 패치 적용 완료. GitHub Desktop에서 변경과 삭제를 Commit/Push하세요.
git status --short
endlocal
