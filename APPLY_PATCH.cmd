...
setlocal
cd /d "%~dp0"
node scripts\apply-delete-list.mjs docs\patches\0.9.3-beta.3-engine-heartbeat-5.2-ui-ux-polish\DELETE_LIST.txt || exit /b 1
...
echo Engine Heartbeat 5.2 UI/UX Polish 적용 완료. GitHub Desktop에서 변경을 Commit/Push하세요.
git status --short
endlocal
