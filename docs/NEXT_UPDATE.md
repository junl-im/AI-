...
`0.9.3-beta.3 · Engine Heartbeat 6.8.3 · Trust Key Rotation & Evidence Renewal Queue`
...
- `services/api/app/services/voice_preset_approval.py`, key ring·재서명·감사 bundle
...
- 신뢰 키는 환경 변수 또는 외부 secret store에서 관리하며 저장소, ZIP, 진단 복사본과 감사 묶음에 포함하지 않습니다.
...
- 서명 secret이 비어 있으면 unsigned가 정상이며, 가짜 key나 기본 secret을 릴리스에 넣지 않습니다.
