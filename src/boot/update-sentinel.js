// AI Shorts Studio v1.2.1 - visible update sentinel and cache refresh helper
'use strict';

(function installUpdateSentinel(global) {
    const config = global.AIShortsRuntimeConfig || {};
    const versionSync = global.AIShortsVersionSync || {};
    const VERSION = versionSync.version || config.APP_VERSION || 'v1.2.1';
    const BUILD_KEY = versionSync.buildKey || config.BUILD_KEY || '1.2.1-update-sentinel';
