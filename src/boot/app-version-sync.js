// AI Shorts Studio v1.5.0 - single source version sync and delegated update guard
'use strict';

(function installAppVersionSync(global) {
    const FALLBACK_VERSION = 'v1.5.0';
    const FALLBACK_BUILD_KEY = '1.5.0-experience-engine';
