// AI Shorts Studio v1.6.15 - single source version sync and delegated update guard
'use strict';

(function installAppVersionSync(global) {
    const FALLBACK_VERSION = 'v1.6.15';
    const FALLBACK_BUILD_KEY = '1.6.15-preview-cache-diagnostics';
