// AI Shorts Studio v1.4.1 - single source version sync and delegated update guard
'use strict';

(function installAppVersionSync(global) {
    const FALLBACK_VERSION = 'v1.4.1';
    const FALLBACK_BUILD_KEY = '1.4.1-adaptive-mobile';
