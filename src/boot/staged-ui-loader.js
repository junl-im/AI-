// AI Shorts Studio v1.6.20 - staged UI hydration with diagnostics import support
'use strict';
...
(function installStagedUiLoader(global) {
    ...
    const VERSION = String(config.APP_VERSION || 'v1.6.39').replace(/^v/i, '');
    ...
    const phases = Object.freeze({
        shell: [
            ...
            versioned('src/ui/motion-stability.js', 'shell'),
            ...
            versioned('src/storage/session-backup-codec.js', 'shell'),
            versioned('src/ui/session-continuity.js', 'shell'),
            versioned('src/ui/storage-health-panel.js', 'shell'),
            versioned('src/diagnostics/support-diagnostics.js', 'shell'),
        ...
        editing: [
            ...
            versioned('src/ui/crop-keyframe-timeline.js', 'editing'),
