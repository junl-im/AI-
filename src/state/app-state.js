// AI Shorts Studio v1.6.20 - director-grade smart-reframe state and persisted-setting recovery
'use strict';
...
(function exposeState(global) {
    ...
    const state = {
        ...
        motionAnalysis: null,
        smartReframe: null,
        smartReframeEdits: { subjectId: 'auto', keyframes: [], speakerPriority: true, speakerLayout: { orientation: 'vertical', split: 0.5, primaryPosition: 'top', gridPrimarySize: 0.54, gridPrimaryPosition: 'top', gridPaging: 'rotate', gridPageSeconds: 3, gridTransition: 'fade', gridTransitionMs: 320, gridManualPages: [], gridManualPageSeconds: [] }, speakerCues: [] },
        transcriptSegments: [],
        isReframing: false,
        autoCuts: null,
        engineMeta: null,
