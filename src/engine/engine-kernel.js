// AI Shorts Studio v1.6.2 - contract-aware layered analysis cache and selective invalidation facade
'use strict';
...
(function exposeEngineKernel(global) {
    ...
    const ENGINE_VERSION = String(config.APP_VERSION || 'v1.6.2').replace(/^v/i, '');
