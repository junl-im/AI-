// AI Shorts Studio v1.6.15 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.15-preview-cache-diagnostics';
...
const SHELL_FILES = [
    ...
    './assets/css/theme.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/studio.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/editor.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/ux.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/advanced-editor.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/layout-dock.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/caption-pro.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/quality-tools.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/auto-cut.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/cut-markers.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/feedback-ux.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/engine-panel.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/pro-engine.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/hyperflow-tabs.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/render-queue.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/hyperconnect-flow.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/flow-polish.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/flow-hotfix.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/flow-integrity.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/flow-doctor.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/responsive-workspace.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/flow-quality-gate.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/glass-pro-ui.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/workspace-comfort.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/motion-stability.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/handoff-coach.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/save-readiness.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/render-quality-planner.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/candidate-preview-pro.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/candidate-pin-board.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/session-continuity.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/storage-health-panel.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/local-ai-studio.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/export-finish-center.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/shutter-glass-flow.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/update-sentinel.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/foundation-polish.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/desktop-prime-layout.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/hero-command-deck.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/ui-refinement.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/icon-system.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/header-meta-rail.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/active-stage-beacon.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/workspace-layout-controls.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/workflow-focus-layout.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/smart-reframe.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/mobile-menu-guide.css?v=1.6.15-preview-cache-diagnostics',
    './assets/css/studio-experience.css?v=1.6.15-preview-cache-diagnostics',
    ...
    './src/config/app-runtime-config.js?v=1.6.15-preview-cache-diagnostics',
    './src/boot/app-version-sync.js?v=1.6.15-preview-cache-diagnostics',
    './src/boot/update-sentinel.js?v=1.6.15-preview-cache-diagnostics',
    './src/boot/staged-ui-loader.js?v=1.6.15-preview-cache-diagnostics',
    './src/vision/vision-model-pack-manager.js?v=1.6.15-preview-cache-diagnostics',
    './src/vision/smart-reframe-engine.js?v=1.6.15-preview-cache-diagnostics',
    './src/vision/speaker-face-linker.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/vision-model-pack-panel.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/direct-crop-editor.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/crop-keyframe-timeline.js?v=1.6.15-preview-cache-diagnostics',
    './src/utils/core-utils.js?v=1.6.15-preview-cache-diagnostics',
    './src/storage/storage-manager.js?v=1.6.15-preview-cache-diagnostics',
    './src/storage/session-backup-codec.js?v=1.6.15-preview-cache-diagnostics',
    './src/state/app-state.js?v=1.6.15-preview-cache-diagnostics',
    './src/engine/operation-coordinator.js?v=1.6.15-preview-cache-diagnostics',
    './src/ai/ai-job-coordinator.js?v=1.6.15-preview-cache-diagnostics',
    './src/ai/local-ai-provider-registry.js?v=1.6.15-preview-cache-diagnostics',
    './src/analysis/audio-analysis-core.js?v=1.6.15-preview-cache-diagnostics',
    './src/analysis/audio-feature-extractor.js?v=1.6.15-preview-cache-diagnostics',
    './src/analysis/video-motion-analyzer.js?v=1.6.15-preview-cache-diagnostics',
    './src/analysis/auto-cut-detector.js?v=1.6.15-preview-cache-diagnostics',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.15-preview-cache-diagnostics',
    './src/engine/module-registry.js?v=1.6.15-preview-cache-diagnostics',
    ...
    './src/engine/performance-budget.js?v=1.6.15-preview-cache-diagnostics',
    './src/engine/analysis-pipeline.js?v=1.6.15-preview-cache-diagnostics',
    './src/engine/scoring-pipeline.js?v=1.6.15-preview-cache-diagnostics',
    ...
    './src/engine/engine-boost-profile.js?v=1.6.15-preview-cache-diagnostics',
    './src/engine/engine-kernel.js?v=1.6.15-preview-cache-diagnostics',
    './src/caption/caption-service.js?v=1.6.15-preview-cache-diagnostics',
    './src/project/project-service.js?v=1.6.15-preview-cache-diagnostics',
    './src/render/quality-effects.js?v=1.6.15-preview-cache-diagnostics',
    './src/render/vertical-renderer.js?v=1.6.15-preview-cache-diagnostics',
    './src/download/download-service.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/waveform-view.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/cut-marker-overlay.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/timeline-view.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/bottom-dock.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/mobile-menu-guide.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/feedback-ux.js?v=1.6.15-preview-cache-diagnostics',
    './src/render/render-queue.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/hyperflow-tabs.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/motion-stability.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/flow-director-final.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/flow-command-bridge.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/workspace-layout-controls.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/workflow-focus-layout.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/startup-performance.js?v=1.6.15-preview-cache-diagnostics',
    './src/security/site-guards.js?v=1.6.15-preview-cache-diagnostics',
    './src/boot/service-worker-registration.js?v=1.6.15-preview-cache-diagnostics',
    './src/boot/runtime-health.js?v=1.6.15-preview-cache-diagnostics',
    './src/app/render-workflow-controller.js?v=1.6.15-preview-cache-diagnostics',
    './src/app/settings-controller.js?v=1.6.15-preview-cache-diagnostics',
    './src/app/preview-controller.js?v=1.6.15-preview-cache-diagnostics',
    './src/app/media-import-controller.js?v=1.6.15-preview-cache-diagnostics',
    './src/app.js?v=1.6.15-preview-cache-diagnostics',
    './src/ui/local-ai-studio.js?v=1.6.15-preview-cache-diagnostics',
...
const INTEGRITY_MANIFEST_SHA256 = '32b349fe59957ba743679b852a675cb5c8088a80bf579bc0df8ae9dd30ca6096';
