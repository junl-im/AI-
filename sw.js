// AI Shorts Studio v1.6.40 service worker - version-aware cache guard and named Local AI endpoint profiles and reconnect-safe trust state
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.40-local-ai-endpoint-profiles';
...
const SHELL_FILES = [
    ...
    './assets/css/theme.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/studio.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/editor.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/ux.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/advanced-editor.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/layout-dock.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/caption-pro.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/quality-tools.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/auto-cut.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/cut-markers.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/feedback-ux.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/engine-panel.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/pro-engine.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/hyperflow-tabs.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/render-queue.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/hyperconnect-flow.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/flow-polish.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/flow-hotfix.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/flow-integrity.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/flow-doctor.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/responsive-workspace.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/flow-quality-gate.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/glass-pro-ui.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/workspace-comfort.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/motion-stability.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/handoff-coach.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/save-readiness.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/render-quality-planner.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/candidate-preview-pro.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/candidate-pin-board.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/session-continuity.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/storage-health-panel.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/local-ai-studio.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/export-finish-center.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/shutter-glass-flow.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/update-sentinel.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/foundation-polish.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/desktop-prime-layout.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/hero-command-deck.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/ui-refinement.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/icon-system.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/header-meta-rail.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/active-stage-beacon.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/workspace-layout-controls.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/workflow-focus-layout.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/smart-reframe.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/mobile-menu-guide.css?v=1.6.40-local-ai-endpoint-profiles',
    './assets/css/studio-experience.css?v=1.6.40-local-ai-endpoint-profiles',
    ...
    './src/config/app-runtime-config.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/boot/app-version-sync.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/boot/update-sentinel.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/boot/staged-ui-loader.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/vision/vision-model-pack-manager.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/vision/smart-reframe-engine.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/vision/speaker-face-linker.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/vision-model-pack-panel.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/direct-crop-editor.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/crop-keyframe-timeline.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/utils/core-utils.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/storage/storage-manager.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/storage/session-backup-codec.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/diagnostics/support-diagnostics.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/state/app-state.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/operation-coordinator.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ai/ai-job-coordinator.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ai/local-ai-provider-registry.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/analysis/audio-analysis-core.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/analysis/audio-feature-extractor.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/analysis/video-motion-analyzer.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/analysis/auto-cut-detector.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/module-registry.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/module-contracts.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/analysis-cache.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/performance-budget.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/analysis-pipeline.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/scoring-pipeline.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/pro-engine-tuner.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/stability-auditor.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/engine-boost-profile.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/engine/engine-kernel.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/caption/caption-service.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/project/project-service.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/render/quality-effects.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/render/vertical-renderer.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/download/download-service.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/waveform-view.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/cut-marker-overlay.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/timeline-view.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/bottom-dock.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/mobile-menu-guide.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/feedback-ux.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/render/render-queue.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/hyperflow-tabs.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/motion-stability.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/flow-director-final.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/flow-command-bridge.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/workspace-layout-controls.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/workflow-focus-layout.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/startup-performance.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/security/site-guards.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/boot/service-worker-registration.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/boot/runtime-health.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/app/render-workflow-controller.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/app/settings-controller.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/app/preview-controller.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/app/analysis-controller.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/app/media-import-controller.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/app.js?v=1.6.40-local-ai-endpoint-profiles',
    './src/ui/local-ai-studio.js?v=1.6.40-local-ai-endpoint-profiles',
...
const INTEGRITY_MANIFEST_SHA256 = '0edcb298f0484ab806af510f28326cbfc7e94cd1159f77418dcc759e0e0569a7';
