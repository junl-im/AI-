// AI Shorts Studio v1.6.12 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.12-model-pack-benchmark-rollback';
...
const SHELL_FILES = [
    ...
    './assets/css/theme.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/studio.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/editor.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/ux.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/advanced-editor.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/layout-dock.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/caption-pro.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/quality-tools.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/auto-cut.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/cut-markers.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/feedback-ux.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/engine-panel.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/pro-engine.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/hyperflow-tabs.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/render-queue.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/hyperconnect-flow.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/flow-polish.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/flow-hotfix.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/flow-integrity.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/flow-doctor.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/responsive-workspace.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/flow-quality-gate.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/glass-pro-ui.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/workspace-comfort.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/motion-stability.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/handoff-coach.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/save-readiness.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/render-quality-planner.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/candidate-preview-pro.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/candidate-pin-board.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/session-continuity.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/storage-health-panel.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/local-ai-studio.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/export-finish-center.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/shutter-glass-flow.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/update-sentinel.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/foundation-polish.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/desktop-prime-layout.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/hero-command-deck.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/ui-refinement.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/icon-system.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/header-meta-rail.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/active-stage-beacon.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/workspace-layout-controls.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/workflow-focus-layout.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/smart-reframe.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/mobile-menu-guide.css?v=1.6.12-model-pack-benchmark-rollback',
    './assets/css/studio-experience.css?v=1.6.12-model-pack-benchmark-rollback',
    ...
    './src/config/app-runtime-config.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/boot/app-version-sync.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/boot/update-sentinel.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/boot/staged-ui-loader.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/vision/vision-model-pack-manager.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/vision/smart-reframe-engine.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/vision/speaker-face-linker.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/vision-model-pack-panel.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/direct-crop-editor.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/crop-keyframe-timeline.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/utils/core-utils.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/storage/storage-manager.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/storage/session-backup-codec.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/state/app-state.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/engine/operation-coordinator.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ai/ai-job-coordinator.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ai/local-ai-provider-registry.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/analysis/audio-analysis-core.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/analysis/audio-feature-extractor.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/analysis/video-motion-analyzer.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/analysis/auto-cut-detector.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/engine/module-registry.js?v=1.6.12-model-pack-benchmark-rollback',
    ...
    './src/engine/performance-budget.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/engine/analysis-pipeline.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/engine/scoring-pipeline.js?v=1.6.12-model-pack-benchmark-rollback',
    ...
    './src/engine/engine-boost-profile.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/engine/engine-kernel.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/caption/caption-service.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/project/project-service.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/render/quality-effects.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/render/vertical-renderer.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/download/download-service.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/waveform-view.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/cut-marker-overlay.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/timeline-view.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/bottom-dock.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/mobile-menu-guide.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/feedback-ux.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/render/render-queue.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/hyperflow-tabs.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/motion-stability.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/flow-director-final.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/flow-command-bridge.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/workspace-layout-controls.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/workflow-focus-layout.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/startup-performance.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/security/site-guards.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/boot/service-worker-registration.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/boot/runtime-health.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/app/render-workflow-controller.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/app/settings-controller.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/app/media-import-controller.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/app.js?v=1.6.12-model-pack-benchmark-rollback',
    './src/ui/local-ai-studio.js?v=1.6.12-model-pack-benchmark-rollback',
...
const INTEGRITY_MANIFEST_SHA256 = 'a1c6c6fe514cbedb65cc4e14dce2da6090869633ec0b9589f58394c39090b56b';
