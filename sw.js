// AI Shorts Studio v1.6.0 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.0-local-ai-provider-foundation';
const SHELL_FILES = [
    './',
    './index.html',
    './manifest.webmanifest',
    './asset-integrity.json',
    './assets/css/theme.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/studio.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/editor.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/ux.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/advanced-editor.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/layout-dock.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/caption-pro.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/quality-tools.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/auto-cut.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/cut-markers.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/feedback-ux.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/engine-panel.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/pro-engine.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/hyperflow-tabs.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/render-queue.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/hyperconnect-flow.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/flow-polish.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/flow-hotfix.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/flow-integrity.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/flow-doctor.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/responsive-workspace.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/flow-quality-gate.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/glass-pro-ui.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/workspace-comfort.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/motion-stability.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/handoff-coach.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/save-readiness.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/render-quality-planner.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/candidate-preview-pro.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/candidate-pin-board.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/session-continuity.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/storage-health-panel.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/local-ai-studio.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/export-finish-center.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/shutter-glass-flow.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/update-sentinel.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/foundation-polish.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/desktop-prime-layout.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/hero-command-deck.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/ui-refinement.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/icon-system.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/header-meta-rail.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/active-stage-beacon.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/workspace-layout-controls.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/mobile-menu-guide.css?v=1.6.0-local-ai-provider-foundation',
    './assets/css/studio-experience.css?v=1.6.0-local-ai-provider-foundation',
    ...
    './src/config/app-runtime-config.js?v=1.6.0-local-ai-provider-foundation',
    './src/boot/app-version-sync.js?v=1.6.0-local-ai-provider-foundation',
    './src/boot/update-sentinel.js?v=1.6.0-local-ai-provider-foundation',
    './src/boot/staged-ui-loader.js?v=1.6.0-local-ai-provider-foundation',
    './src/utils/core-utils.js?v=1.6.0-local-ai-provider-foundation',
    './src/storage/storage-manager.js?v=1.6.0-local-ai-provider-foundation',
    './src/storage/session-backup-codec.js?v=1.6.0-local-ai-provider-foundation',
    './src/state/app-state.js?v=1.6.0-local-ai-provider-foundation',
    './src/engine/operation-coordinator.js?v=1.6.0-local-ai-provider-foundation',
    './src/ai/ai-job-coordinator.js?v=1.6.0-local-ai-provider-foundation',
    './src/ai/local-ai-provider-registry.js?v=1.6.0-local-ai-provider-foundation',
    './src/analysis/audio-analysis-core.js?v=1.6.0-local-ai-provider-foundation',
    './src/analysis/audio-feature-extractor.js?v=1.6.0-local-ai-provider-foundation',
    './src/analysis/video-motion-analyzer.js?v=1.6.0-local-ai-provider-foundation',
    './src/analysis/auto-cut-detector.js?v=1.6.0-local-ai-provider-foundation',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.0-local-ai-provider-foundation',
    './src/engine/module-registry.js?v=1.6.0-local-ai-provider-foundation',
    ...
    './src/engine/performance-budget.js?v=1.6.0-local-ai-provider-foundation',
    './src/engine/analysis-pipeline.js?v=1.6.0-local-ai-provider-foundation',
    './src/engine/scoring-pipeline.js?v=1.6.0-local-ai-provider-foundation',
    ...
    './src/engine/engine-boost-profile.js?v=1.6.0-local-ai-provider-foundation',
    './src/engine/engine-kernel.js?v=1.6.0-local-ai-provider-foundation',
    './src/caption/caption-service.js?v=1.6.0-local-ai-provider-foundation',
    './src/project/project-service.js?v=1.6.0-local-ai-provider-foundation',
    './src/render/quality-effects.js?v=1.6.0-local-ai-provider-foundation',
    './src/render/vertical-renderer.js?v=1.6.0-local-ai-provider-foundation',
    './src/download/download-service.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/waveform-view.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/cut-marker-overlay.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/timeline-view.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/bottom-dock.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/mobile-menu-guide.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/feedback-ux.js?v=1.6.0-local-ai-provider-foundation',
    './src/render/render-queue.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/hyperflow-tabs.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/motion-stability.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/flow-director-final.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/flow-command-bridge.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/workspace-layout-controls.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/startup-performance.js?v=1.6.0-local-ai-provider-foundation',
    './src/security/site-guards.js?v=1.6.0-local-ai-provider-foundation',
    './src/boot/service-worker-registration.js?v=1.6.0-local-ai-provider-foundation',
    './src/boot/runtime-health.js?v=1.6.0-local-ai-provider-foundation',
    './src/app/render-workflow-controller.js?v=1.6.0-local-ai-provider-foundation',
    './src/app/settings-controller.js?v=1.6.0-local-ai-provider-foundation',
    './src/app/media-import-controller.js?v=1.6.0-local-ai-provider-foundation',
    './src/app.js?v=1.6.0-local-ai-provider-foundation',
    './src/ui/local-ai-studio.js?v=1.6.0-local-ai-provider-foundation',
...
const INTEGRITY_MANIFEST_SHA256 = '60a33dc29b68769518cd2016f17f26b5cdfba98ac558350e08131ff55ceb0c6b';
