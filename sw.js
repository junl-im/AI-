// AI Shorts Studio v1.6.30 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.30-energy-manual-paging-transitions';
...
const SHELL_FILES = [
    ...
    './assets/css/theme.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/studio.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/editor.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/ux.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/advanced-editor.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/layout-dock.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/caption-pro.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/quality-tools.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/auto-cut.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/cut-markers.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/feedback-ux.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/engine-panel.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/pro-engine.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/hyperflow-tabs.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/render-queue.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/hyperconnect-flow.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/flow-polish.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/flow-hotfix.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/flow-integrity.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/flow-doctor.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/responsive-workspace.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/flow-quality-gate.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/glass-pro-ui.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/workspace-comfort.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/motion-stability.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/handoff-coach.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/save-readiness.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/render-quality-planner.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/candidate-preview-pro.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/candidate-pin-board.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/session-continuity.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/storage-health-panel.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/local-ai-studio.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/export-finish-center.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/shutter-glass-flow.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/update-sentinel.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/foundation-polish.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/desktop-prime-layout.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/hero-command-deck.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/ui-refinement.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/icon-system.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/header-meta-rail.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/active-stage-beacon.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/workspace-layout-controls.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/workflow-focus-layout.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/smart-reframe.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/mobile-menu-guide.css?v=1.6.30-energy-manual-paging-transitions',
    './assets/css/studio-experience.css?v=1.6.30-energy-manual-paging-transitions',
    ...
    './src/config/app-runtime-config.js?v=1.6.30-energy-manual-paging-transitions',
    './src/boot/app-version-sync.js?v=1.6.30-energy-manual-paging-transitions',
    './src/boot/update-sentinel.js?v=1.6.30-energy-manual-paging-transitions',
    './src/boot/staged-ui-loader.js?v=1.6.30-energy-manual-paging-transitions',
    './src/vision/vision-model-pack-manager.js?v=1.6.30-energy-manual-paging-transitions',
    './src/vision/smart-reframe-engine.js?v=1.6.30-energy-manual-paging-transitions',
    './src/vision/speaker-face-linker.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/vision-model-pack-panel.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/direct-crop-editor.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/crop-keyframe-timeline.js?v=1.6.30-energy-manual-paging-transitions',
    './src/utils/core-utils.js?v=1.6.30-energy-manual-paging-transitions',
    './src/storage/storage-manager.js?v=1.6.30-energy-manual-paging-transitions',
    './src/storage/session-backup-codec.js?v=1.6.30-energy-manual-paging-transitions',
    './src/diagnostics/support-diagnostics.js?v=1.6.30-energy-manual-paging-transitions',
    './src/state/app-state.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/operation-coordinator.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ai/ai-job-coordinator.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ai/local-ai-provider-registry.js?v=1.6.30-energy-manual-paging-transitions',
    './src/analysis/audio-analysis-core.js?v=1.6.30-energy-manual-paging-transitions',
    './src/analysis/audio-feature-extractor.js?v=1.6.30-energy-manual-paging-transitions',
    './src/analysis/video-motion-analyzer.js?v=1.6.30-energy-manual-paging-transitions',
    './src/analysis/auto-cut-detector.js?v=1.6.30-energy-manual-paging-transitions',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/module-registry.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/module-contracts.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/analysis-cache.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/performance-budget.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/analysis-pipeline.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/scoring-pipeline.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/pro-engine-tuner.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/stability-auditor.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/engine-boost-profile.js?v=1.6.30-energy-manual-paging-transitions',
    './src/engine/engine-kernel.js?v=1.6.30-energy-manual-paging-transitions',
    './src/caption/caption-service.js?v=1.6.30-energy-manual-paging-transitions',
    './src/project/project-service.js?v=1.6.30-energy-manual-paging-transitions',
    './src/render/quality-effects.js?v=1.6.30-energy-manual-paging-transitions',
    './src/render/vertical-renderer.js?v=1.6.30-energy-manual-paging-transitions',
    './src/download/download-service.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/waveform-view.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/cut-marker-overlay.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/timeline-view.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/bottom-dock.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/mobile-menu-guide.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/feedback-ux.js?v=1.6.30-energy-manual-paging-transitions',
    './src/render/render-queue.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/hyperflow-tabs.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/motion-stability.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/flow-director-final.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/flow-command-bridge.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/workspace-layout-controls.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/workflow-focus-layout.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/startup-performance.js?v=1.6.30-energy-manual-paging-transitions',
    './src/security/site-guards.js?v=1.6.30-energy-manual-paging-transitions',
    './src/boot/service-worker-registration.js?v=1.6.30-energy-manual-paging-transitions',
    './src/boot/runtime-health.js?v=1.6.30-energy-manual-paging-transitions',
    './src/app/render-workflow-controller.js?v=1.6.30-energy-manual-paging-transitions',
    './src/app/settings-controller.js?v=1.6.30-energy-manual-paging-transitions',
    './src/app/preview-controller.js?v=1.6.30-energy-manual-paging-transitions',
    './src/app/analysis-controller.js?v=1.6.30-energy-manual-paging-transitions',
    './src/app/media-import-controller.js?v=1.6.30-energy-manual-paging-transitions',
    './src/app.js?v=1.6.30-energy-manual-paging-transitions',
    './src/ui/local-ai-studio.js?v=1.6.30-energy-manual-paging-transitions',
...
const INTEGRITY_MANIFEST_SHA256 = 'a1fb7c74e82b391ec0047be5d4422f93115265b0c1f56d6d0465b6c20a08088a';
