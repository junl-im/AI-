// AI Shorts Studio v1.6.1 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.1-advanced-diagnostics-gate';
const SHELL_FILES = [
    './',
    './index.html',
    './manifest.webmanifest',
    './asset-integrity.json',
    './assets/css/theme.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/studio.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/editor.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/ux.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/advanced-editor.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/layout-dock.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/caption-pro.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/quality-tools.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/auto-cut.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/cut-markers.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/feedback-ux.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/engine-panel.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/pro-engine.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/hyperflow-tabs.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/render-queue.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/hyperconnect-flow.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/flow-polish.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/flow-hotfix.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/flow-integrity.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/flow-doctor.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/responsive-workspace.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/flow-quality-gate.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/glass-pro-ui.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/workspace-comfort.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/motion-stability.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/handoff-coach.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/save-readiness.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/render-quality-planner.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/candidate-preview-pro.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/candidate-pin-board.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/session-continuity.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/storage-health-panel.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/local-ai-studio.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/export-finish-center.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/shutter-glass-flow.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/update-sentinel.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/foundation-polish.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/desktop-prime-layout.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/hero-command-deck.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/ui-refinement.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/icon-system.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/header-meta-rail.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/active-stage-beacon.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/workspace-layout-controls.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/mobile-menu-guide.css?v=1.6.1-advanced-diagnostics-gate',
    './assets/css/studio-experience.css?v=1.6.1-advanced-diagnostics-gate',
    ...
    './src/config/app-runtime-config.js?v=1.6.1-advanced-diagnostics-gate',
    './src/boot/app-version-sync.js?v=1.6.1-advanced-diagnostics-gate',
    './src/boot/update-sentinel.js?v=1.6.1-advanced-diagnostics-gate',
    './src/boot/staged-ui-loader.js?v=1.6.1-advanced-diagnostics-gate',
    './src/utils/core-utils.js?v=1.6.1-advanced-diagnostics-gate',
    './src/storage/storage-manager.js?v=1.6.1-advanced-diagnostics-gate',
    './src/storage/session-backup-codec.js?v=1.6.1-advanced-diagnostics-gate',
    './src/state/app-state.js?v=1.6.1-advanced-diagnostics-gate',
    './src/engine/operation-coordinator.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ai/ai-job-coordinator.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ai/local-ai-provider-registry.js?v=1.6.1-advanced-diagnostics-gate',
    './src/analysis/audio-analysis-core.js?v=1.6.1-advanced-diagnostics-gate',
    './src/analysis/audio-feature-extractor.js?v=1.6.1-advanced-diagnostics-gate',
    './src/analysis/video-motion-analyzer.js?v=1.6.1-advanced-diagnostics-gate',
    './src/analysis/auto-cut-detector.js?v=1.6.1-advanced-diagnostics-gate',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.1-advanced-diagnostics-gate',
    './src/engine/module-registry.js?v=1.6.1-advanced-diagnostics-gate',
    ...
    './src/engine/performance-budget.js?v=1.6.1-advanced-diagnostics-gate',
    './src/engine/analysis-pipeline.js?v=1.6.1-advanced-diagnostics-gate',
    './src/engine/scoring-pipeline.js?v=1.6.1-advanced-diagnostics-gate',
    ...
    './src/engine/engine-boost-profile.js?v=1.6.1-advanced-diagnostics-gate',
    './src/engine/engine-kernel.js?v=1.6.1-advanced-diagnostics-gate',
    './src/caption/caption-service.js?v=1.6.1-advanced-diagnostics-gate',
    './src/project/project-service.js?v=1.6.1-advanced-diagnostics-gate',
    './src/render/quality-effects.js?v=1.6.1-advanced-diagnostics-gate',
    './src/render/vertical-renderer.js?v=1.6.1-advanced-diagnostics-gate',
    './src/download/download-service.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/waveform-view.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/cut-marker-overlay.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/timeline-view.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/bottom-dock.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/mobile-menu-guide.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/feedback-ux.js?v=1.6.1-advanced-diagnostics-gate',
    './src/render/render-queue.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/hyperflow-tabs.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/motion-stability.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/flow-director-final.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/flow-command-bridge.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/workspace-layout-controls.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/startup-performance.js?v=1.6.1-advanced-diagnostics-gate',
    './src/security/site-guards.js?v=1.6.1-advanced-diagnostics-gate',
    './src/boot/service-worker-registration.js?v=1.6.1-advanced-diagnostics-gate',
    './src/boot/runtime-health.js?v=1.6.1-advanced-diagnostics-gate',
    './src/app/render-workflow-controller.js?v=1.6.1-advanced-diagnostics-gate',
    './src/app/settings-controller.js?v=1.6.1-advanced-diagnostics-gate',
    './src/app/media-import-controller.js?v=1.6.1-advanced-diagnostics-gate',
    './src/app.js?v=1.6.1-advanced-diagnostics-gate',
    './src/ui/local-ai-studio.js?v=1.6.1-advanced-diagnostics-gate',
...
const INTEGRITY_MANIFEST_SHA256 = '6d5c3d519cf5f645c8266ae1012e9ff746d8cd58b9fe29fc1b590501d7e60cfd';
