// AI Shorts Studio v1.5.29 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.5.29-analysis-signature-storage-trend';
const SHELL_FILES = [
    './',
    './index.html',
    './manifest.webmanifest',
    './asset-integrity.json',
    './assets/css/theme.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/studio.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/editor.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/ux.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/advanced-editor.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/layout-dock.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/caption-pro.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/quality-tools.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/auto-cut.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/cut-markers.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/feedback-ux.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/engine-panel.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/pro-engine.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/hyperflow-tabs.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/render-queue.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/hyperconnect-flow.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/flow-polish.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/flow-hotfix.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/flow-integrity.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/flow-doctor.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/responsive-workspace.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/flow-quality-gate.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/glass-pro-ui.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/workspace-comfort.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/motion-stability.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/handoff-coach.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/save-readiness.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/render-quality-planner.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/candidate-preview-pro.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/candidate-pin-board.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/session-continuity.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/storage-health-panel.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/export-finish-center.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/shutter-glass-flow.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/update-sentinel.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/foundation-polish.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/desktop-prime-layout.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/hero-command-deck.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/ui-refinement.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/icon-system.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/header-meta-rail.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/active-stage-beacon.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/workspace-layout-controls.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/mobile-menu-guide.css?v=1.5.29-analysis-signature-storage-trend',
    './assets/css/studio-experience.css?v=1.5.29-analysis-signature-storage-trend',
    ...
    './src/config/app-runtime-config.js?v=1.5.29-analysis-signature-storage-trend',
    './src/boot/app-version-sync.js?v=1.5.29-analysis-signature-storage-trend',
    './src/boot/update-sentinel.js?v=1.5.29-analysis-signature-storage-trend',
    './src/boot/staged-ui-loader.js?v=1.5.29-analysis-signature-storage-trend',
    './src/utils/core-utils.js?v=1.5.29-analysis-signature-storage-trend',
    './src/storage/storage-manager.js?v=1.5.29-analysis-signature-storage-trend',
    './src/storage/session-backup-codec.js?v=1.5.29-analysis-signature-storage-trend',
    './src/state/app-state.js?v=1.5.29-analysis-signature-storage-trend',
    './src/engine/operation-coordinator.js?v=1.5.29-analysis-signature-storage-trend',
    './src/analysis/audio-analysis-core.js?v=1.5.29-analysis-signature-storage-trend',
    './src/analysis/audio-feature-extractor.js?v=1.5.29-analysis-signature-storage-trend',
    './src/analysis/video-motion-analyzer.js?v=1.5.29-analysis-signature-storage-trend',
    './src/analysis/auto-cut-detector.js?v=1.5.29-analysis-signature-storage-trend',
    './src/recommendation/shorts-recommendation-engine.js?v=1.5.29-analysis-signature-storage-trend',
    './src/engine/module-registry.js?v=1.5.29-analysis-signature-storage-trend',
    ...
    './src/engine/performance-budget.js?v=1.5.29-analysis-signature-storage-trend',
    './src/engine/analysis-pipeline.js?v=1.5.29-analysis-signature-storage-trend',
    './src/engine/scoring-pipeline.js?v=1.5.29-analysis-signature-storage-trend',
    ...
    './src/engine/engine-boost-profile.js?v=1.5.29-analysis-signature-storage-trend',
    './src/engine/engine-kernel.js?v=1.5.29-analysis-signature-storage-trend',
    './src/caption/caption-service.js?v=1.5.29-analysis-signature-storage-trend',
    './src/project/project-service.js?v=1.5.29-analysis-signature-storage-trend',
    './src/render/quality-effects.js?v=1.5.29-analysis-signature-storage-trend',
    './src/render/vertical-renderer.js?v=1.5.29-analysis-signature-storage-trend',
    './src/download/download-service.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/waveform-view.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/cut-marker-overlay.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/timeline-view.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/bottom-dock.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/mobile-menu-guide.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/feedback-ux.js?v=1.5.29-analysis-signature-storage-trend',
    './src/render/render-queue.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/hyperflow-tabs.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/motion-stability.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/flow-director-final.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/flow-command-bridge.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/workspace-layout-controls.js?v=1.5.29-analysis-signature-storage-trend',
    './src/ui/startup-performance.js?v=1.5.29-analysis-signature-storage-trend',
    './src/security/site-guards.js?v=1.5.29-analysis-signature-storage-trend',
    './src/boot/service-worker-registration.js?v=1.5.29-analysis-signature-storage-trend',
    './src/boot/runtime-health.js?v=1.5.29-analysis-signature-storage-trend',
    './src/app/render-workflow-controller.js?v=1.5.29-analysis-signature-storage-trend',
    './src/app/settings-controller.js?v=1.5.29-analysis-signature-storage-trend',
    './src/app/media-import-controller.js?v=1.5.29-analysis-signature-storage-trend',
    './src/app.js?v=1.5.29-analysis-signature-storage-trend',
...
const INTEGRITY_MANIFEST_SHA256 = '4eb8b7df55b5ab9a86221036a18075c440cee0d53efd3955bfd58f92a6c4185d';
