// AI Shorts Studio v1.6.13 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.13-transactional-model-pack-qa-controls';
...
const SHELL_FILES = [
    ...
    './assets/css/theme.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/studio.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/editor.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/ux.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/advanced-editor.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/layout-dock.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/caption-pro.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/quality-tools.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/auto-cut.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/cut-markers.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/feedback-ux.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/engine-panel.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/pro-engine.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/hyperflow-tabs.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/render-queue.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/hyperconnect-flow.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/flow-polish.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/flow-hotfix.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/flow-integrity.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/flow-doctor.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/responsive-workspace.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/flow-quality-gate.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/glass-pro-ui.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/workspace-comfort.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/motion-stability.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/handoff-coach.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/save-readiness.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/render-quality-planner.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/candidate-preview-pro.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/candidate-pin-board.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/session-continuity.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/storage-health-panel.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/local-ai-studio.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/export-finish-center.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/shutter-glass-flow.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/update-sentinel.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/foundation-polish.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/desktop-prime-layout.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/hero-command-deck.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/ui-refinement.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/icon-system.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/header-meta-rail.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/active-stage-beacon.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/workspace-layout-controls.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/workflow-focus-layout.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/smart-reframe.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/mobile-menu-guide.css?v=1.6.13-transactional-model-pack-qa-controls',
    './assets/css/studio-experience.css?v=1.6.13-transactional-model-pack-qa-controls',
    ...
    './src/config/app-runtime-config.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/boot/app-version-sync.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/boot/update-sentinel.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/boot/staged-ui-loader.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/vision/vision-model-pack-manager.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/vision/smart-reframe-engine.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/vision/speaker-face-linker.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/vision-model-pack-panel.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/direct-crop-editor.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/crop-keyframe-timeline.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/utils/core-utils.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/storage/storage-manager.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/storage/session-backup-codec.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/state/app-state.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/engine/operation-coordinator.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ai/ai-job-coordinator.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ai/local-ai-provider-registry.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/analysis/audio-analysis-core.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/analysis/audio-feature-extractor.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/analysis/video-motion-analyzer.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/analysis/auto-cut-detector.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/engine/module-registry.js?v=1.6.13-transactional-model-pack-qa-controls',
    ...
    './src/engine/performance-budget.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/engine/analysis-pipeline.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/engine/scoring-pipeline.js?v=1.6.13-transactional-model-pack-qa-controls',
    ...
    './src/engine/engine-boost-profile.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/engine/engine-kernel.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/caption/caption-service.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/project/project-service.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/render/quality-effects.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/render/vertical-renderer.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/download/download-service.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/waveform-view.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/cut-marker-overlay.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/timeline-view.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/bottom-dock.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/mobile-menu-guide.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/feedback-ux.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/render/render-queue.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/hyperflow-tabs.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/motion-stability.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/flow-director-final.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/flow-command-bridge.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/workspace-layout-controls.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/workflow-focus-layout.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/startup-performance.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/security/site-guards.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/boot/service-worker-registration.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/boot/runtime-health.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/app/render-workflow-controller.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/app/settings-controller.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/app/media-import-controller.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/app.js?v=1.6.13-transactional-model-pack-qa-controls',
    './src/ui/local-ai-studio.js?v=1.6.13-transactional-model-pack-qa-controls',
...
const INTEGRITY_MANIFEST_SHA256 = '9bd4f9a31098f99f6cc0178ef01a580d07f8d47699d325a073d5ce407a772bd7';
