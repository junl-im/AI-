// AI Shorts Studio v1.6.4 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.4-recovery-loop-impact-preview';
const SHELL_FILES = [
    './',
    './index.html',
    './manifest.webmanifest',
    './asset-integrity.json',
    './assets/css/theme.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/studio.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/editor.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/ux.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/advanced-editor.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/layout-dock.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/caption-pro.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/quality-tools.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/auto-cut.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/cut-markers.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/feedback-ux.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/engine-panel.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/pro-engine.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/hyperflow-tabs.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/render-queue.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/hyperconnect-flow.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/flow-polish.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/flow-hotfix.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/flow-integrity.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/flow-doctor.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/responsive-workspace.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/flow-quality-gate.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/glass-pro-ui.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/workspace-comfort.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/motion-stability.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/handoff-coach.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/save-readiness.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/render-quality-planner.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/candidate-preview-pro.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/candidate-pin-board.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/session-continuity.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/storage-health-panel.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/local-ai-studio.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/export-finish-center.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/shutter-glass-flow.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/update-sentinel.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/foundation-polish.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/desktop-prime-layout.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/hero-command-deck.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/ui-refinement.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/icon-system.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/header-meta-rail.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/active-stage-beacon.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/workspace-layout-controls.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/workflow-focus-layout.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/mobile-menu-guide.css?v=1.6.4-recovery-loop-impact-preview',
    './assets/css/studio-experience.css?v=1.6.4-recovery-loop-impact-preview',
    ...
    './src/config/app-runtime-config.js?v=1.6.4-recovery-loop-impact-preview',
    './src/boot/app-version-sync.js?v=1.6.4-recovery-loop-impact-preview',
    './src/boot/update-sentinel.js?v=1.6.4-recovery-loop-impact-preview',
    './src/boot/staged-ui-loader.js?v=1.6.4-recovery-loop-impact-preview',
    './src/utils/core-utils.js?v=1.6.4-recovery-loop-impact-preview',
    './src/storage/storage-manager.js?v=1.6.4-recovery-loop-impact-preview',
    './src/storage/session-backup-codec.js?v=1.6.4-recovery-loop-impact-preview',
    './src/state/app-state.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/operation-coordinator.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ai/ai-job-coordinator.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ai/local-ai-provider-registry.js?v=1.6.4-recovery-loop-impact-preview',
    './src/analysis/audio-analysis-core.js?v=1.6.4-recovery-loop-impact-preview',
    './src/analysis/audio-feature-extractor.js?v=1.6.4-recovery-loop-impact-preview',
    './src/analysis/video-motion-analyzer.js?v=1.6.4-recovery-loop-impact-preview',
    './src/analysis/auto-cut-detector.js?v=1.6.4-recovery-loop-impact-preview',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/module-registry.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/module-contracts.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/analysis-cache.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/performance-budget.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/analysis-pipeline.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/scoring-pipeline.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/pro-engine-tuner.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/stability-auditor.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/engine-boost-profile.js?v=1.6.4-recovery-loop-impact-preview',
    './src/engine/engine-kernel.js?v=1.6.4-recovery-loop-impact-preview',
    './src/caption/caption-service.js?v=1.6.4-recovery-loop-impact-preview',
    './src/project/project-service.js?v=1.6.4-recovery-loop-impact-preview',
    './src/render/quality-effects.js?v=1.6.4-recovery-loop-impact-preview',
    './src/render/vertical-renderer.js?v=1.6.4-recovery-loop-impact-preview',
    './src/download/download-service.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/waveform-view.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/cut-marker-overlay.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/timeline-view.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/bottom-dock.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/mobile-menu-guide.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/feedback-ux.js?v=1.6.4-recovery-loop-impact-preview',
    './src/render/render-queue.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/hyperflow-tabs.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/motion-stability.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/flow-director-final.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/flow-command-bridge.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/workspace-layout-controls.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/workflow-focus-layout.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/startup-performance.js?v=1.6.4-recovery-loop-impact-preview',
    './src/security/site-guards.js?v=1.6.4-recovery-loop-impact-preview',
    './src/boot/service-worker-registration.js?v=1.6.4-recovery-loop-impact-preview',
    './src/boot/runtime-health.js?v=1.6.4-recovery-loop-impact-preview',
    './src/app/render-workflow-controller.js?v=1.6.4-recovery-loop-impact-preview',
    './src/app/settings-controller.js?v=1.6.4-recovery-loop-impact-preview',
    './src/app/media-import-controller.js?v=1.6.4-recovery-loop-impact-preview',
    './src/app.js?v=1.6.4-recovery-loop-impact-preview',
    './src/ui/local-ai-studio.js?v=1.6.4-recovery-loop-impact-preview',
...
const INTEGRITY_MANIFEST_SHA256 = '82dc07a4b0961b527a990e8cb9e71f0889808235c29e5bae54b67445efc3dea8';
