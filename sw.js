// AI Shorts Studio v1.5.28 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.5.28-analysis-namespace-maintenance-history';
const SHELL_FILES = [
    './',
    './index.html',
    './manifest.webmanifest',
    './asset-integrity.json',
    './assets/css/theme.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/studio.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/editor.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/ux.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/advanced-editor.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/layout-dock.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/caption-pro.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/quality-tools.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/auto-cut.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/cut-markers.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/feedback-ux.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/engine-panel.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/pro-engine.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/hyperflow-tabs.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/render-queue.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/hyperconnect-flow.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/flow-polish.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/flow-hotfix.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/flow-integrity.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/flow-doctor.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/responsive-workspace.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/flow-quality-gate.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/glass-pro-ui.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/workspace-comfort.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/motion-stability.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/handoff-coach.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/save-readiness.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/render-quality-planner.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/candidate-preview-pro.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/candidate-pin-board.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/session-continuity.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/storage-health-panel.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/export-finish-center.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/shutter-glass-flow.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/update-sentinel.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/foundation-polish.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/desktop-prime-layout.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/hero-command-deck.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/ui-refinement.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/icon-system.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/header-meta-rail.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/active-stage-beacon.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/workspace-layout-controls.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/mobile-menu-guide.css?v=1.5.28-analysis-namespace-maintenance-history',
    './assets/css/studio-experience.css?v=1.5.28-analysis-namespace-maintenance-history',
    ...
    './src/config/app-runtime-config.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/boot/app-version-sync.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/boot/update-sentinel.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/boot/staged-ui-loader.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/utils/core-utils.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/storage/storage-manager.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/storage/session-backup-codec.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/state/app-state.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/operation-coordinator.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/analysis/audio-analysis-core.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/analysis/audio-feature-extractor.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/analysis/video-motion-analyzer.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/analysis/auto-cut-detector.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/recommendation/shorts-recommendation-engine.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/module-registry.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/module-contracts.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/analysis-cache.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/performance-budget.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/analysis-pipeline.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/scoring-pipeline.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/pro-engine-tuner.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/stability-auditor.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/engine-boost-profile.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/engine/engine-kernel.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/caption/caption-service.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/project/project-service.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/render/quality-effects.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/render/vertical-renderer.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/download/download-service.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/waveform-view.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/cut-marker-overlay.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/timeline-view.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/bottom-dock.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/mobile-menu-guide.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/feedback-ux.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/render/render-queue.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/hyperflow-tabs.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/motion-stability.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/flow-director-final.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/flow-command-bridge.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/workspace-layout-controls.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/ui/startup-performance.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/security/site-guards.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/boot/service-worker-registration.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/boot/runtime-health.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/app/render-workflow-controller.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/app/settings-controller.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/app/media-import-controller.js?v=1.5.28-analysis-namespace-maintenance-history',
    './src/app.js?v=1.5.28-analysis-namespace-maintenance-history',
...
const INTEGRITY_MANIFEST_SHA256 = 'c3c4411e03162474f3187674996ba257cd094d9aa7713e38f9076af76b8be06c';
