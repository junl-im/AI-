// AI Shorts Studio v1.6.39 service worker - version-aware cache guard and local AI probe cancellation and deadline release
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.39-local-ai-endpoint-pins';
...
const SHELL_FILES = [
    ...
    './assets/css/theme.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/studio.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/editor.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/ux.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/advanced-editor.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/layout-dock.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/caption-pro.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/quality-tools.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/auto-cut.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/cut-markers.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/feedback-ux.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/engine-panel.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/pro-engine.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/hyperflow-tabs.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/render-queue.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/hyperconnect-flow.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/flow-polish.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/flow-hotfix.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/flow-integrity.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/flow-doctor.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/responsive-workspace.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/flow-quality-gate.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/glass-pro-ui.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/workspace-comfort.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/motion-stability.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/handoff-coach.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/save-readiness.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/render-quality-planner.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/candidate-preview-pro.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/candidate-pin-board.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/session-continuity.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/storage-health-panel.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/local-ai-studio.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/export-finish-center.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/shutter-glass-flow.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/update-sentinel.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/foundation-polish.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/desktop-prime-layout.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/hero-command-deck.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/ui-refinement.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/icon-system.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/header-meta-rail.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/active-stage-beacon.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/workspace-layout-controls.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/workflow-focus-layout.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/smart-reframe.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/mobile-menu-guide.css?v=1.6.39-local-ai-endpoint-pins',
    './assets/css/studio-experience.css?v=1.6.39-local-ai-endpoint-pins',
    ...
    './src/config/app-runtime-config.js?v=1.6.39-local-ai-endpoint-pins',
    './src/boot/app-version-sync.js?v=1.6.39-local-ai-endpoint-pins',
    './src/boot/update-sentinel.js?v=1.6.39-local-ai-endpoint-pins',
    './src/boot/staged-ui-loader.js?v=1.6.39-local-ai-endpoint-pins',
    './src/vision/vision-model-pack-manager.js?v=1.6.39-local-ai-endpoint-pins',
    './src/vision/smart-reframe-engine.js?v=1.6.39-local-ai-endpoint-pins',
    './src/vision/speaker-face-linker.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/vision-model-pack-panel.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/direct-crop-editor.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/crop-keyframe-timeline.js?v=1.6.39-local-ai-endpoint-pins',
    './src/utils/core-utils.js?v=1.6.39-local-ai-endpoint-pins',
    './src/storage/storage-manager.js?v=1.6.39-local-ai-endpoint-pins',
    './src/storage/session-backup-codec.js?v=1.6.39-local-ai-endpoint-pins',
    './src/diagnostics/support-diagnostics.js?v=1.6.39-local-ai-endpoint-pins',
    './src/state/app-state.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/operation-coordinator.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ai/ai-job-coordinator.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ai/local-ai-provider-registry.js?v=1.6.39-local-ai-endpoint-pins',
    './src/analysis/audio-analysis-core.js?v=1.6.39-local-ai-endpoint-pins',
    './src/analysis/audio-feature-extractor.js?v=1.6.39-local-ai-endpoint-pins',
    './src/analysis/video-motion-analyzer.js?v=1.6.39-local-ai-endpoint-pins',
    './src/analysis/auto-cut-detector.js?v=1.6.39-local-ai-endpoint-pins',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/module-registry.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/module-contracts.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/analysis-cache.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/performance-budget.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/analysis-pipeline.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/scoring-pipeline.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/pro-engine-tuner.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/stability-auditor.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/engine-boost-profile.js?v=1.6.39-local-ai-endpoint-pins',
    './src/engine/engine-kernel.js?v=1.6.39-local-ai-endpoint-pins',
    './src/caption/caption-service.js?v=1.6.39-local-ai-endpoint-pins',
    './src/project/project-service.js?v=1.6.39-local-ai-endpoint-pins',
    './src/render/quality-effects.js?v=1.6.39-local-ai-endpoint-pins',
    './src/render/vertical-renderer.js?v=1.6.39-local-ai-endpoint-pins',
    './src/download/download-service.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/waveform-view.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/cut-marker-overlay.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/timeline-view.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/bottom-dock.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/mobile-menu-guide.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/feedback-ux.js?v=1.6.39-local-ai-endpoint-pins',
    './src/render/render-queue.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/hyperflow-tabs.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/motion-stability.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/flow-director-final.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/flow-command-bridge.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/workspace-layout-controls.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/workflow-focus-layout.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/startup-performance.js?v=1.6.39-local-ai-endpoint-pins',
    './src/security/site-guards.js?v=1.6.39-local-ai-endpoint-pins',
    './src/boot/service-worker-registration.js?v=1.6.39-local-ai-endpoint-pins',
    './src/boot/runtime-health.js?v=1.6.39-local-ai-endpoint-pins',
    './src/app/render-workflow-controller.js?v=1.6.39-local-ai-endpoint-pins',
    './src/app/settings-controller.js?v=1.6.39-local-ai-endpoint-pins',
    './src/app/preview-controller.js?v=1.6.39-local-ai-endpoint-pins',
    './src/app/analysis-controller.js?v=1.6.39-local-ai-endpoint-pins',
    './src/app/media-import-controller.js?v=1.6.39-local-ai-endpoint-pins',
    './src/app.js?v=1.6.39-local-ai-endpoint-pins',
    './src/ui/local-ai-studio.js?v=1.6.39-local-ai-endpoint-pins',
...
const INTEGRITY_MANIFEST_SHA256 = '9bbb075f71d8ab75bd67fdcc161e34320d510ebc53ee7f1361725c42e7232d44';
