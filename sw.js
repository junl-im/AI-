// AI Shorts Studio v1.6.3 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.3-stage-focus-progressive-disclosure';
const SHELL_FILES = [
    './',
    './index.html',
    './manifest.webmanifest',
    './asset-integrity.json',
    './assets/css/theme.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/studio.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/editor.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/ux.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/advanced-editor.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/layout-dock.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/caption-pro.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/quality-tools.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/auto-cut.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/cut-markers.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/feedback-ux.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/engine-panel.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/pro-engine.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/hyperflow-tabs.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/render-queue.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/hyperconnect-flow.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/flow-polish.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/flow-hotfix.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/flow-integrity.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/flow-doctor.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/responsive-workspace.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/flow-quality-gate.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/glass-pro-ui.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/workspace-comfort.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/motion-stability.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/handoff-coach.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/save-readiness.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/render-quality-planner.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/candidate-preview-pro.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/candidate-pin-board.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/session-continuity.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/storage-health-panel.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/local-ai-studio.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/export-finish-center.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/shutter-glass-flow.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/update-sentinel.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/foundation-polish.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/desktop-prime-layout.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/hero-command-deck.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/ui-refinement.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/icon-system.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/header-meta-rail.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/active-stage-beacon.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/workspace-layout-controls.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/workflow-focus-layout.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/mobile-menu-guide.css?v=1.6.3-stage-focus-progressive-disclosure',
    './assets/css/studio-experience.css?v=1.6.3-stage-focus-progressive-disclosure',
    ...
    './src/config/app-runtime-config.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/boot/app-version-sync.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/boot/update-sentinel.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/boot/staged-ui-loader.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/utils/core-utils.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/storage/storage-manager.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/storage/session-backup-codec.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/state/app-state.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/operation-coordinator.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ai/ai-job-coordinator.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ai/local-ai-provider-registry.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/analysis/audio-analysis-core.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/analysis/audio-feature-extractor.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/analysis/video-motion-analyzer.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/analysis/auto-cut-detector.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/module-registry.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/module-contracts.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/analysis-cache.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/performance-budget.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/analysis-pipeline.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/scoring-pipeline.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/pro-engine-tuner.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/stability-auditor.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/engine-boost-profile.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/engine/engine-kernel.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/caption/caption-service.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/project/project-service.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/render/quality-effects.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/render/vertical-renderer.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/download/download-service.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/waveform-view.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/cut-marker-overlay.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/timeline-view.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/bottom-dock.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/mobile-menu-guide.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/feedback-ux.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/render/render-queue.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/hyperflow-tabs.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/motion-stability.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/flow-director-final.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/flow-command-bridge.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/workspace-layout-controls.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/workflow-focus-layout.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/startup-performance.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/security/site-guards.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/boot/service-worker-registration.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/boot/runtime-health.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/app/render-workflow-controller.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/app/settings-controller.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/app/media-import-controller.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/app.js?v=1.6.3-stage-focus-progressive-disclosure',
    './src/ui/local-ai-studio.js?v=1.6.3-stage-focus-progressive-disclosure',
...
const INTEGRITY_MANIFEST_SHA256 = '10bb3139b5432e99e2eb32179a4ac91ec7a0b6924f48d21fd73786b1b8b0452c';
