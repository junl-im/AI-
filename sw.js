// AI Shorts Studio v1.6.2 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.2-layout-harmony-footer-health';
const SHELL_FILES = [
    './',
    './index.html',
    './manifest.webmanifest',
    './asset-integrity.json',
    './assets/css/theme.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/studio.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/editor.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/ux.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/advanced-editor.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/layout-dock.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/caption-pro.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/quality-tools.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/auto-cut.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/cut-markers.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/feedback-ux.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/engine-panel.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/pro-engine.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/hyperflow-tabs.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/render-queue.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/hyperconnect-flow.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/flow-polish.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/flow-hotfix.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/flow-integrity.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/flow-doctor.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/responsive-workspace.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/flow-quality-gate.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/glass-pro-ui.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/workspace-comfort.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/motion-stability.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/handoff-coach.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/save-readiness.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/render-quality-planner.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/candidate-preview-pro.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/candidate-pin-board.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/session-continuity.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/storage-health-panel.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/local-ai-studio.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/export-finish-center.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/shutter-glass-flow.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/update-sentinel.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/foundation-polish.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/desktop-prime-layout.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/hero-command-deck.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/ui-refinement.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/icon-system.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/header-meta-rail.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/active-stage-beacon.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/workspace-layout-controls.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/mobile-menu-guide.css?v=1.6.2-layout-harmony-footer-health',
    './assets/css/studio-experience.css?v=1.6.2-layout-harmony-footer-health',
    ...
    './src/config/app-runtime-config.js?v=1.6.2-layout-harmony-footer-health',
    './src/boot/app-version-sync.js?v=1.6.2-layout-harmony-footer-health',
    './src/boot/update-sentinel.js?v=1.6.2-layout-harmony-footer-health',
    './src/boot/staged-ui-loader.js?v=1.6.2-layout-harmony-footer-health',
    './src/utils/core-utils.js?v=1.6.2-layout-harmony-footer-health',
    './src/storage/storage-manager.js?v=1.6.2-layout-harmony-footer-health',
    './src/storage/session-backup-codec.js?v=1.6.2-layout-harmony-footer-health',
    './src/state/app-state.js?v=1.6.2-layout-harmony-footer-health',
    './src/engine/operation-coordinator.js?v=1.6.2-layout-harmony-footer-health',
    './src/ai/ai-job-coordinator.js?v=1.6.2-layout-harmony-footer-health',
    './src/ai/local-ai-provider-registry.js?v=1.6.2-layout-harmony-footer-health',
    './src/analysis/audio-analysis-core.js?v=1.6.2-layout-harmony-footer-health',
    './src/analysis/audio-feature-extractor.js?v=1.6.2-layout-harmony-footer-health',
    './src/analysis/video-motion-analyzer.js?v=1.6.2-layout-harmony-footer-health',
    './src/analysis/auto-cut-detector.js?v=1.6.2-layout-harmony-footer-health',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.2-layout-harmony-footer-health',
    './src/engine/module-registry.js?v=1.6.2-layout-harmony-footer-health',
    ...
    './src/engine/performance-budget.js?v=1.6.2-layout-harmony-footer-health',
    './src/engine/analysis-pipeline.js?v=1.6.2-layout-harmony-footer-health',
    './src/engine/scoring-pipeline.js?v=1.6.2-layout-harmony-footer-health',
    ...
    './src/engine/engine-boost-profile.js?v=1.6.2-layout-harmony-footer-health',
    './src/engine/engine-kernel.js?v=1.6.2-layout-harmony-footer-health',
    './src/caption/caption-service.js?v=1.6.2-layout-harmony-footer-health',
    './src/project/project-service.js?v=1.6.2-layout-harmony-footer-health',
    './src/render/quality-effects.js?v=1.6.2-layout-harmony-footer-health',
    './src/render/vertical-renderer.js?v=1.6.2-layout-harmony-footer-health',
    './src/download/download-service.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/waveform-view.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/cut-marker-overlay.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/timeline-view.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/bottom-dock.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/mobile-menu-guide.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/feedback-ux.js?v=1.6.2-layout-harmony-footer-health',
    './src/render/render-queue.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/hyperflow-tabs.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/motion-stability.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/flow-director-final.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/flow-command-bridge.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/workspace-layout-controls.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/startup-performance.js?v=1.6.2-layout-harmony-footer-health',
    './src/security/site-guards.js?v=1.6.2-layout-harmony-footer-health',
    './src/boot/service-worker-registration.js?v=1.6.2-layout-harmony-footer-health',
    './src/boot/runtime-health.js?v=1.6.2-layout-harmony-footer-health',
    './src/app/render-workflow-controller.js?v=1.6.2-layout-harmony-footer-health',
    './src/app/settings-controller.js?v=1.6.2-layout-harmony-footer-health',
    './src/app/media-import-controller.js?v=1.6.2-layout-harmony-footer-health',
    './src/app.js?v=1.6.2-layout-harmony-footer-health',
    './src/ui/local-ai-studio.js?v=1.6.2-layout-harmony-footer-health',
...
const INTEGRITY_MANIFEST_SHA256 = '29f956170a25eca70d25e75afedea36a8192956ed4143eb0b56044debb560d95';
