// AI Shorts Studio v1.6.32 service worker - version-aware cache guard, targeted integrity retry, audit history control, and rollback-safe activation
'use strict';

const CACHE_PREFIX = 'ai-shorts-studio-shell-';
const CACHE_NAME = 'ai-shorts-studio-shell-v1.6.32-page-timing-subject-order-energy-status';
...
const SHELL_FILES = [
    ...
    './assets/css/theme.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/studio.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/editor.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/ux.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/advanced-editor.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/layout-dock.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/caption-pro.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/quality-tools.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/auto-cut.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/cut-markers.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/feedback-ux.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/engine-panel.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/pro-engine.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/hyperflow-tabs.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/render-queue.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/hyperconnect-flow.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/flow-polish.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/flow-hotfix.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/flow-integrity.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/flow-doctor.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/responsive-workspace.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/flow-quality-gate.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/pc-dock-reveal-hotfix.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/glass-pro-ui.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/workspace-comfort.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/motion-stability.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/handoff-coach.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/save-readiness.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/render-quality-planner.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/candidate-preview-pro.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/candidate-pin-board.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/session-continuity.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/storage-health-panel.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/local-ai-studio.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/export-finish-center.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/shutter-glass-flow.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/update-sentinel.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/foundation-polish.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/desktop-prime-layout.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/hero-command-deck.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/ui-refinement.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/icon-system.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/header-meta-rail.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/active-stage-beacon.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/workspace-layout-controls.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/workflow-focus-layout.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/smart-reframe.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/mobile-menu-guide.css?v=1.6.32-page-timing-subject-order-energy-status',
    './assets/css/studio-experience.css?v=1.6.32-page-timing-subject-order-energy-status',
    ...
    './src/config/app-runtime-config.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/boot/app-version-sync.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/boot/update-sentinel.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/boot/staged-ui-loader.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/vision/vision-model-pack-manager.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/vision/smart-reframe-engine.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/vision/speaker-face-linker.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/vision-model-pack-panel.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/direct-crop-editor.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/crop-keyframe-timeline.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/utils/core-utils.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/storage/storage-manager.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/storage/session-backup-codec.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/diagnostics/support-diagnostics.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/state/app-state.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/operation-coordinator.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ai/ai-job-coordinator.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ai/local-ai-provider-registry.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/analysis/audio-analysis-core.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/analysis/audio-feature-extractor.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/analysis/video-motion-analyzer.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/analysis/auto-cut-detector.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/recommendation/shorts-recommendation-engine.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/module-registry.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/module-contracts.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/analysis-cache.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/performance-budget.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/analysis-pipeline.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/scoring-pipeline.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/pro-engine-tuner.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/stability-auditor.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/engine-boost-profile.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/engine/engine-kernel.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/caption/caption-service.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/project/project-service.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/render/quality-effects.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/render/vertical-renderer.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/download/download-service.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/waveform-view.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/cut-marker-overlay.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/timeline-view.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/bottom-dock.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/mobile-menu-guide.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/feedback-ux.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/render/render-queue.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/hyperflow-tabs.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/motion-stability.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/flow-director-final.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/flow-command-bridge.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/workspace-layout-controls.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/workflow-focus-layout.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/startup-performance.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/security/site-guards.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/boot/service-worker-registration.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/boot/runtime-health.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/app/render-workflow-controller.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/app/settings-controller.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/app/preview-controller.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/app/analysis-controller.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/app/media-import-controller.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/app.js?v=1.6.32-page-timing-subject-order-energy-status',
    './src/ui/local-ai-studio.js?v=1.6.32-page-timing-subject-order-energy-status',
...
const INTEGRITY_MANIFEST_SHA256 = '29809a1637112e3db0fab5b825dcc75b418e186fdfeaba083f993d5a8a184c6f';
